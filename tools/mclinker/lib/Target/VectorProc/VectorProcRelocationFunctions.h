...
#define DECL_VECTORPROC_APPLY_RELOC_FUNC_PTRS(ValueType, MappedType) \
  ValueType(0x0,   MappedType(&abs, "R_VECTORPROC_ABS32")), \
  ValueType(0x1, MappedType(&branch, "R_VECTORPROC_BRANCH")), \
  ValueType(0x2, MappedType(&mem, "R_VECTORPROC_PCREL_MEM", 32)), \
  ValueType(0x3, MappedType(&memext, "R_VECTORPROC_PCREL_MEM_EXT", 32))
