...
or s21, s22, -36 # CHECK: 0xb6,0x72,0x7f,0x00
or v24, v25, -9 # CHECK: 0x19,0xdf,0x7f,0x10
or_mask v27, s1, v0, -114 # CHECK: 0x60,0x07,0x47,0x20
or v2, s3, 7 # CHECK: 0x43,0x1c,0x00,0x40
or_mask v5, s7, s6, 86 # CHECK: 0xa6,0x1c,0x2b,0x50
...
and s0, s1, -26 # CHECK: 0x01,0x98,0xff,0x00
and v3, v4, 60 # CHECK: 0x64,0xf0,0x80,0x10
and_mask v6, s8, v7, 116 # CHECK: 0xc7,0x20,0xba,0x20
and v9, s10, 90 # CHECK: 0x2a,0x69,0x81,0x40
and_mask v12, s14, s13, 38 # CHECK: 0x8d,0x39,0x93,0x50
...
xor s7, s8, -37 # CHECK: 0xe8,0x6c,0xff,0x01
xor v10, v11, 53 # CHECK: 0x4b,0xd5,0x80,0x11
xor_mask v13, s15, v14, 65 # CHECK: 0xae,0xbd,0xa0,0x21
xor v16, s17, 97 # CHECK: 0x11,0x86,0x81,0x41
xor_mask v19, s21, s20, 94 # CHECK: 0x74,0x56,0xaf,0x51
...
add_i s14, s15, 62 # CHECK: 0xcf,0xf9,0x80,0x02
add_i v17, v18, -22 # CHECK: 0x32,0xaa,0xff,0x12
add_i_mask v20, s22, v21, 80 # CHECK: 0x95,0x5a,0xa8,0x22
add_i v23, s24, -60 # CHECK: 0xf8,0x12,0xff,0x42
add_i_mask v26, s0, s27, 79 # CHECK: 0x5b,0x83,0xa7,0x52
...
sub_i s21, s22, 79 # CHECK: 0xb6,0x3e,0x01,0x03
sub_i v24, v25, 28 # CHECK: 0x19,0x73,0x00,0x13
sub_i_mask v27, s1, v0, -63 # CHECK: 0x60,0x87,0x60,0x23
sub_i v2, s3, 0 # CHECK: 0x43,0x00,0x00,0x43
sub_i_mask v5, s7, s6, 36 # CHECK: 0xa6,0x1c,0x12,0x53
...
mul_i s0, s1, 67 # CHECK: 0x01,0x0c,0x81,0x03
mul_i v3, v4, 104 # CHECK: 0x64,0xa0,0x81,0x13
mul_i_mask v6, s8, v7, -71 # CHECK: 0xc7,0xa0,0xdc,0x23
mul_i v9, s10, 72 # CHECK: 0x2a,0x21,0x81,0x43
mul_i_mask v12, s14, s13, 26 # CHECK: 0x8d,0x39,0x8d,0x53
...
ashr s7, s8, -5 # CHECK: 0xe8,0xec,0xff,0x04
ashr v10, v11, 114 # CHECK: 0x4b,0xc9,0x81,0x14
ashr_mask v13, s15, v14, -8 # CHECK: 0xae,0x3d,0xfc,0x24
ashr v16, s17, -17 # CHECK: 0x11,0xbe,0xff,0x44
ashr_mask v19, s21, s20, -116 # CHECK: 0x74,0x56,0xc6,0x54
...
shr s14, s15, 35 # CHECK: 0xcf,0x8d,0x00,0x05
shr v17, v18, 24 # CHECK: 0x32,0x62,0x00,0x15
shr_mask v20, s22, v21, -113 # CHECK: 0x95,0xda,0x47,0x25
shr v23, s24, 100 # CHECK: 0xf8,0x92,0x01,0x45
shr_mask v26, s0, s27, 44 # CHECK: 0x5b,0x03,0x16,0x55
...
shl s21, s22, 123 # CHECK: 0xb6,0xee,0x81,0x05
shl v24, v25, 125 # CHECK: 0x19,0xf7,0x81,0x15
shl_mask v27, s1, v0, -115 # CHECK: 0x60,0x87,0xc6,0x25
shl v2, s3, 121 # CHECK: 0x43,0xe4,0x81,0x45
shl_mask v5, s7, s6, -6 # CHECK: 0xa6,0x1c,0xfd,0x55
...
floor s13, s14 # CHECK: 0xa0,0x01,0x77,0xc2
floor v13, s14 # CHECK: 0xa0,0x01,0x77,0xc6
floor_mask v13, s15, s14 # CHECK: 0xa0,0x3d,0x77,0xca
floor v13, v14 # CHECK: 0xa0,0x01,0x77,0xd2
floor_mask v13, s15, v14 # CHECK: 0xa0,0x3d,0x77,0xd6
abs_f s16, s17 # CHECK: 0x00,0x82,0x98,0xc2
abs_f v16, s17 # CHECK: 0x00,0x82,0x98,0xc6
abs_f_mask v16, s18, s17 # CHECK: 0x00,0xca,0x98,0xca
abs_f v16, v17 # CHECK: 0x00,0x82,0x98,0xd2
abs_f_mask v16, s18, v17 # CHECK: 0x00,0xca,0x98,0xd6
...
cmpeq_i s1, s2, 122 # CHECK: 0x22,0xe8,0x01,0x08
cmpeq_i s1, v2, 122 # CHECK: 0x22,0xe8,0x01,0x18
...
cmpgt_i s7, s8, 241 # CHECK: 0xe8,0xc4,0x03,0x09
cmpgt_i s7, v8, 241 # CHECK: 0xe8,0xc4,0x03,0x19
...
cmpge_i s10, s11, 149 # CHECK: 0x4b,0x55,0x82,0x09
cmpge_i s10, v11, 149 # CHECK: 0x4b,0x55,0x82,0x19
...
cmplt_i s13, s14, 46 # CHECK: 0xae,0xb9,0x00,0x0a
cmplt_i s13, v14, 46 # CHECK: 0xae,0xb9,0x00,0x1a
...
cmple_i s16, s17, 54 # CHECK: 0x11,0xda,0x80,0x0a
cmple_i s16, v17, 54 # CHECK: 0x11,0xda,0x80,0x1a
...
cmpgt_u s19, s20, 213 # CHECK: 0x74,0x56,0x03,0x0b
cmpgt_u s19, v20, 213 # CHECK: 0x74,0x56,0x03,0x1b
...
cmpge_u s22, s23, 52 # CHECK: 0xd7,0xd2,0x80,0x0b
cmpge_u s22, v23, 52 # CHECK: 0xd7,0xd2,0x80,0x1b
...
cmplt_u s25, s26, 163 # CHECK: 0x3a,0x8f,0x02,0x0c
cmplt_u s25, v26, 163 # CHECK: 0x3a,0x8f,0x02,0x1c
...
cmple_u s0, s1, 154 # CHECK: 0x01,0x68,0x82,0x0c
cmple_u s0, v1, 154 # CHECK: 0x01,0x68,0x82,0x1c
...
load_v v1, 52(s2) # CHECK: 0x22,0xd0,0x00,0xae
load_v_mask v1, s3, 52(s2) # CHECK: 0x22,0x0c,0x1a,0xb0
load_v v1, (s2) # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 52(s2) # CHECK: 0x22,0xd0,0x00,0x8e
store_v_mask v1, s3, 52(s2) # CHECK: 0x22,0x0c,0x1a,0x90
store_v v1, (s2) # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 376(v5) # CHECK: 0x85,0xe0,0x05,0xba
load_gath_mask v4, s6, 376(v5) # CHECK: 0x85,0x18,0xbc,0xbc
load_gath v4, (v5) # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5) # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 376(v5) # CHECK: 0x85,0xe0,0x05,0x9a
store_scat_mask v4, s6, 376(v5) # CHECK: 0x85,0x18,0xbc,0x9c
