...
or s21, s22, 99                  # CHECK: 0xb6,0x8e,0x01,0x00
or v24, v25, -43                 # CHECK: 0x19,0x57,0xff,0x20
or_mask v27, s1, v0, 18          # CHECK: 0x60,0x07,0x09,0x60
...
and s22, s23, -127               # CHECK: 0xd7,0x06,0xfe,0x01
and v25, v26, 82                 # CHECK: 0x3a,0x4b,0x01,0x21
and_mask v0, s2, v1, -16         # CHECK: 0x01,0x08,0xf8,0x61
...
xor s23, s24, 50                 # CHECK: 0xf8,0xca,0x00,0x03
xor v26, v27, 109                # CHECK: 0x5b,0xb7,0x01,0x23
xor_mask v1, s3, v2, -79         # CHECK: 0x22,0x8c,0xd8,0x63
...
add_i s24, s25, 94               # CHECK: 0x19,0x7b,0x01,0x05
add_i v27, v0, -59               # CHECK: 0x60,0x17,0xff,0x25
add_i_mask v2, s4, v3, 62        # CHECK: 0x43,0x10,0x1f,0x65
...
sub_i s25, s26, 36               # CHECK: 0x3a,0x93,0x00,0x06
sub_i v0, v1, 123                # CHECK: 0x01,0xec,0x01,0x26
sub_i_mask v3, s5, v4, -24       # CHECK: 0x64,0x14,0xf4,0x66
...
mull_i s26, s27, -30             # CHECK: 0x5b,0x8b,0xff,0x07
mull_i v1, v2, -38               # CHECK: 0x22,0x68,0xff,0x27
mull_i_mask v4, s6, v5, -41      # CHECK: 0x85,0x98,0xeb,0x67
...
mulh_u s27, s0, -61              # CHECK: 0x60,0x0f,0xff,0x08
mulh_u v2, v3, -53               # CHECK: 0x43,0x2c,0xff,0x28
mulh_u_mask v5, s7, v6, -21      # CHECK: 0xa6,0x9c,0xf5,0x68
...
ashr s0, s1, 121                 # CHECK: 0x01,0xe4,0x01,0x09
ashr v3, v4, -117                # CHECK: 0x64,0x2c,0xfe,0x29
ashr_mask v6, s8, v7, 22         # CHECK: 0xc7,0x20,0x0b,0x69
...
shr s1, s2, -121                 # CHECK: 0x22,0x1c,0xfe,0x0a
shr v4, v5, -3                   # CHECK: 0x85,0xf4,0xff,0x2a
shr_mask v7, s9, v8, 0           # CHECK: 0xe8,0x24,0x00,0x6a
...
shl s2, s3, 70                   # CHECK: 0x43,0x18,0x01,0x0b
shl v5, v6, -103                 # CHECK: 0xa6,0x64,0xfe,0x2b
shl_mask v8, s10, v9, 7          # CHECK: 0x09,0xa9,0x03,0x6b
...
mulh_i s7, s8, -87               # CHECK: 0xe8,0xa4,0xfe,0x1f
mulh_i v10, v11, 53              # CHECK: 0x4b,0xd5,0x00,0x3f
mulh_i_mask v13, s15, v14, -83   # CHECK: 0xae,0xbd,0xd6,0x7f
...
cmpeq_i s1, s2, 73               # CHECK: 0x22,0x24,0x01,0x10
cmpeq_i s1, v2, 73               # CHECK: 0x22,0x24,0x01,0x30
...
cmpne_i s4, s5, 46               # CHECK: 0x85,0xb8,0x00,0x11
cmpne_i s4, v5, 46               # CHECK: 0x85,0xb8,0x00,0x31
...
cmpgt_i s7, s8, 34               # CHECK: 0xe8,0x88,0x00,0x12
cmpgt_i s7, v8, 34               # CHECK: 0xe8,0x88,0x00,0x32
...
cmpge_i s10, s11, 108            # CHECK: 0x4b,0xb1,0x01,0x13
cmpge_i s10, v11, 108            # CHECK: 0x4b,0xb1,0x01,0x33
...
cmplt_i s13, s14, 187            # CHECK: 0xae,0xed,0x02,0x14
cmplt_i s13, v14, 187            # CHECK: 0xae,0xed,0x02,0x34
...
cmple_i s16, s17, 68             # CHECK: 0x11,0x12,0x01,0x15
cmple_i s16, v17, 68             # CHECK: 0x11,0x12,0x01,0x35
...
cmpgt_u s19, s20, 136            # CHECK: 0x74,0x22,0x02,0x16
cmpgt_u s19, v20, 136            # CHECK: 0x74,0x22,0x02,0x36
...
cmpge_u s22, s23, 255            # CHECK: 0xd7,0xfe,0x03,0x17
cmpge_u s22, v23, 255            # CHECK: 0xd7,0xfe,0x03,0x37
...
cmplt_u s25, s26, 98             # CHECK: 0x3a,0x8b,0x01,0x18
cmplt_u s25, v26, 98             # CHECK: 0x3a,0x8b,0x01,0x38
...
cmple_u s0, s1, 252              # CHECK: 0x01,0xf0,0x03,0x19
cmple_u s0, v1, 252              # CHECK: 0x01,0xf0,0x03,0x39
...
load_v v1, 312(s2)               # CHECK: 0x22,0xe0,0x04,0xae
load_v_mask v1, s3, 312(s2)      # CHECK: 0x22,0x0c,0x9c,0xb0
load_v v1, (s2)                  # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2)         # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 312(s2)              # CHECK: 0x22,0xe0,0x04,0x8e
store_v_mask v1, s3, 312(s2)     # CHECK: 0x22,0x0c,0x9c,0x90
store_v v1, (s2)                 # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2)        # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 84(v5)             # CHECK: 0x85,0x50,0x01,0xba
load_gath_mask v4, s6, 84(v5)    # CHECK: 0x85,0x18,0x2a,0xbc
load_gath v4, (v5)               # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5)      # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 84(v5)            # CHECK: 0x85,0x50,0x01,0x9a
store_scat_mask v4, s6, 84(v5)   # CHECK: 0x85,0x18,0x2a,0x9c
