...
or s21, s22, -68                 # CHECK: 0xb6,0xf2,0xfe,0x00
or v24, v25, -58                 # CHECK: 0x19,0x1b,0xff,0x20
or_mask v27, s1, v0, 110         # CHECK: 0x60,0x07,0x37,0x60
...
and s22, s23, 6                  # CHECK: 0xd7,0x1a,0x00,0x01
and v25, v26, -56                # CHECK: 0x3a,0x23,0xff,0x21
and_mask v0, s2, v1, -9          # CHECK: 0x01,0x88,0xfb,0x61
...
xor s23, s24, 34                 # CHECK: 0xf8,0x8a,0x00,0x03
xor v26, v27, -45                # CHECK: 0x5b,0x4f,0xff,0x23
xor_mask v1, s3, v2, -42         # CHECK: 0x22,0x0c,0xeb,0x63
...
add_i s24, s25, -105             # CHECK: 0x19,0x5f,0xfe,0x05
add_i v27, v0, 87                # CHECK: 0x60,0x5f,0x01,0x25
add_i_mask v2, s4, v3, -76       # CHECK: 0x43,0x10,0xda,0x65
...
sub_i s25, s26, -103             # CHECK: 0x3a,0x67,0xfe,0x06
sub_i v0, v1, 65                 # CHECK: 0x01,0x04,0x01,0x26
sub_i_mask v3, s5, v4, -114      # CHECK: 0x64,0x14,0xc7,0x66
...
mull_i s26, s27, 60              # CHECK: 0x5b,0xf3,0x00,0x07
mull_i v1, v2, -72               # CHECK: 0x22,0xe0,0xfe,0x27
mull_i_mask v4, s6, v5, -113     # CHECK: 0x85,0x98,0xc7,0x67
...
mulh_u s27, s0, -6               # CHECK: 0x60,0xeb,0xff,0x08
mulh_u v2, v3, 115               # CHECK: 0x43,0xcc,0x01,0x28
mulh_u_mask v5, s7, v6, -54      # CHECK: 0xa6,0x1c,0xe5,0x68
...
ashr s0, s1, -33                 # CHECK: 0x01,0x7c,0xff,0x09
ashr v3, v4, -7                  # CHECK: 0x64,0xe4,0xff,0x29
ashr_mask v6, s8, v7, 112        # CHECK: 0xc7,0x20,0x38,0x69
...
shr s1, s2, 6                    # CHECK: 0x22,0x18,0x00,0x0a
shr v4, v5, 20                   # CHECK: 0x85,0x50,0x00,0x2a
shr_mask v7, s9, v8, 14          # CHECK: 0xe8,0x24,0x07,0x6a
...
shl s2, s3, -86                  # CHECK: 0x43,0xa8,0xfe,0x0b
shl v5, v6, 71                   # CHECK: 0xa6,0x1c,0x01,0x2b
shl_mask v8, s10, v9, -2         # CHECK: 0x09,0x29,0xff,0x6b
...
mulh_i s7, s8, 15                # CHECK: 0xe8,0x3c,0x00,0x1f
mulh_i v10, v11, -43             # CHECK: 0x4b,0x55,0xff,0x3f
mulh_i_mask v13, s15, v14, -67   # CHECK: 0xae,0xbd,0xde,0x7f
...
cmpeq_i s1, s2, 13               # CHECK: 0x22,0x34,0x00,0x10
cmpeq_i s1, v2, 13               # CHECK: 0x22,0x34,0x00,0x30
...
cmpne_i s4, s5, 210              # CHECK: 0x85,0x48,0x03,0x11
cmpne_i s4, v5, 210              # CHECK: 0x85,0x48,0x03,0x31
...
cmpgt_i s7, s8, 77               # CHECK: 0xe8,0x34,0x01,0x12
cmpgt_i s7, v8, 77               # CHECK: 0xe8,0x34,0x01,0x32
...
cmpge_i s10, s11, 34             # CHECK: 0x4b,0x89,0x00,0x13
cmpge_i s10, v11, 34             # CHECK: 0x4b,0x89,0x00,0x33
...
cmplt_i s13, s14, 196            # CHECK: 0xae,0x11,0x03,0x14
cmplt_i s13, v14, 196            # CHECK: 0xae,0x11,0x03,0x34
...
cmple_i s16, s17, 199            # CHECK: 0x11,0x1e,0x03,0x15
cmple_i s16, v17, 199            # CHECK: 0x11,0x1e,0x03,0x35
...
cmpgt_u s19, s20, 63             # CHECK: 0x74,0xfe,0x00,0x16
cmpgt_u s19, v20, 63             # CHECK: 0x74,0xfe,0x00,0x36
...
cmpge_u s22, s23, 81             # CHECK: 0xd7,0x46,0x01,0x17
cmpge_u s22, v23, 81             # CHECK: 0xd7,0x46,0x01,0x37
...
cmplt_u s25, s26, 41             # CHECK: 0x3a,0xa7,0x00,0x18
cmplt_u s25, v26, 41             # CHECK: 0x3a,0xa7,0x00,0x38
...
cmple_u s0, s1, 251              # CHECK: 0x01,0xec,0x03,0x19
cmple_u s0, v1, 251              # CHECK: 0x01,0xec,0x03,0x39
...
load_v v1, 136(s2)               # CHECK: 0x22,0x20,0x02,0xae
load_v_mask v1, s3, 136(s2)      # CHECK: 0x22,0x0c,0x44,0xb0
load_v v1, (s2)                  # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2)         # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 136(s2)              # CHECK: 0x22,0x20,0x02,0x8e
store_v_mask v1, s3, 136(s2)     # CHECK: 0x22,0x0c,0x44,0x90
store_v v1, (s2)                 # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2)        # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 148(v5)            # CHECK: 0x85,0x50,0x02,0xba
load_gath_mask v4, s6, 148(v5)   # CHECK: 0x85,0x18,0x4a,0xbc
load_gath v4, (v5)               # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5)      # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 148(v5)           # CHECK: 0x85,0x50,0x02,0x9a
store_scat_mask v4, s6, 148(v5)  # CHECK: 0x85,0x18,0x4a,0x9c
