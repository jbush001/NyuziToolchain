...
or s21, s22, -2                  # CHECK: 0xb6,0xfa,0x7f,0x00
or v24, v25, -93                 # CHECK: 0x19,0x8f,0x7e,0x10
or_mask v27, s1, v0, 94          # CHECK: 0x60,0x07,0x2f,0x20
or v2, s3, 105                   # CHECK: 0x43,0xa4,0x01,0x40
or_mask v5, s7, s6, -67          # CHECK: 0xa6,0x9c,0x5e,0x50
...
and s0, s1, -116                 # CHECK: 0x01,0x30,0xfe,0x00
and v3, v4, -57                  # CHECK: 0x64,0x1c,0xff,0x10
and_mask v6, s8, v7, -17         # CHECK: 0xc7,0xa0,0xf7,0x20
and v9, s10, 11                  # CHECK: 0x2a,0x2d,0x80,0x40
and_mask v12, s14, s13, -98      # CHECK: 0x8d,0x39,0xcf,0x50
...
xor s7, s8, -99                  # CHECK: 0xe8,0x74,0xfe,0x01
xor v10, v11, -45                # CHECK: 0x4b,0x4d,0xff,0x11
xor_mask v13, s15, v14, -19      # CHECK: 0xae,0xbd,0xf6,0x21
xor v16, s17, 8                  # CHECK: 0x11,0x22,0x80,0x41
xor_mask v19, s21, s20, 117      # CHECK: 0x74,0xd6,0xba,0x51
...
add_i s14, s15, 50               # CHECK: 0xcf,0xc9,0x80,0x02
add_i v17, v18, 31               # CHECK: 0x32,0x7e,0x80,0x12
add_i_mask v20, s22, v21, 70     # CHECK: 0x95,0x5a,0xa3,0x22
add_i v23, s24, -77              # CHECK: 0xf8,0xce,0xfe,0x42
add_i_mask v26, s0, s27, -113    # CHECK: 0x5b,0x83,0xc7,0x52
...
sub_i v24, v25, -35              # CHECK: 0x19,0x77,0x7f,0x13
sub_i_mask v27, s1, v0, -69      # CHECK: 0x60,0x87,0x5d,0x23
sub_i v2, s3, -100               # CHECK: 0x43,0x70,0x7e,0x43
sub_i_mask v5, s7, s6, 67        # CHECK: 0xa6,0x9c,0x21,0x53
...
mull_i s0, s1, -124              # CHECK: 0x01,0x10,0xfe,0x03
mull_i v3, v4, -95               # CHECK: 0x64,0x84,0xfe,0x13
mull_i_mask v6, s8, v7, 97       # CHECK: 0xc7,0xa0,0xb0,0x23
mull_i v9, s10, -56              # CHECK: 0x2a,0x21,0xff,0x43
mull_i_mask v12, s14, s13, -115  # CHECK: 0x8d,0xb9,0xc6,0x53
...
mulh_u s7, s8, -26               # CHECK: 0xe8,0x98,0x7f,0x04
mulh_u v10, v11, -91             # CHECK: 0x4b,0x95,0x7e,0x14
mulh_u_mask v13, s15, v14, -114  # CHECK: 0xae,0x3d,0x47,0x24
mulh_u v16, s17, 5               # CHECK: 0x11,0x16,0x00,0x44
mulh_u_mask v19, s21, s20, 77    # CHECK: 0x74,0xd6,0x26,0x54
...
ashr s14, s15, -66               # CHECK: 0xcf,0xf9,0xfe,0x04
ashr v17, v18, 22                # CHECK: 0x32,0x5a,0x80,0x14
ashr_mask v20, s22, v21, 11      # CHECK: 0x95,0xda,0x85,0x24
ashr v23, s24, -92               # CHECK: 0xf8,0x92,0xfe,0x44
ashr_mask v26, s0, s27, 94       # CHECK: 0x5b,0x03,0xaf,0x54
...
shr s21, s22, -123               # CHECK: 0xb6,0x16,0x7e,0x05
shr v24, v25, 116                # CHECK: 0x19,0xd3,0x01,0x15
shr_mask v27, s1, v0, 85         # CHECK: 0x60,0x87,0x2a,0x25
shr v2, s3, 99                   # CHECK: 0x43,0x8c,0x01,0x45
shr_mask v5, s7, s6, -22         # CHECK: 0xa6,0x1c,0x75,0x55
...
shl s0, s1, 68                   # CHECK: 0x01,0x10,0x81,0x05
shl v3, v4, -49                  # CHECK: 0x64,0x3c,0xff,0x15
shl_mask v6, s8, v7, 88          # CHECK: 0xc7,0x20,0xac,0x25
shl v9, s10, -24                 # CHECK: 0x2a,0xa1,0xff,0x45
shl_mask v12, s14, s13, 11       # CHECK: 0x8d,0xb9,0x85,0x55
...
mulh_i s11, s12, 53              # CHECK: 0x6c,0xd5,0x80,0x0f
mulh_i v14, v15, 25              # CHECK: 0xcf,0x65,0x80,0x1f
mulh_i_mask v17, s19, v18, 41    # CHECK: 0x32,0xce,0x94,0x2f
mulh_i v20, s21, -70             # CHECK: 0x95,0xea,0xfe,0x4f
mulh_i_mask v23, s25, s24, -122  # CHECK: 0xf8,0x66,0xc3,0x5f
...
cmpeq_i s1, s2, 2                # CHECK: 0x22,0x08,0x00,0x08
cmpeq_i s1, v2, 2                # CHECK: 0x22,0x08,0x00,0x18
...
cmpne_i s4, s5, 129              # CHECK: 0x85,0x04,0x82,0x08
cmpne_i s4, v5, 129              # CHECK: 0x85,0x04,0x82,0x18
...
cmpgt_i s7, s8, 56               # CHECK: 0xe8,0xe0,0x00,0x09
cmpgt_i s7, v8, 56               # CHECK: 0xe8,0xe0,0x00,0x19
...
cmpge_i s10, s11, 206            # CHECK: 0x4b,0x39,0x83,0x09
cmpge_i s10, v11, 206            # CHECK: 0x4b,0x39,0x83,0x19
...
cmplt_i s13, s14, 86             # CHECK: 0xae,0x59,0x01,0x0a
cmplt_i s13, v14, 86             # CHECK: 0xae,0x59,0x01,0x1a
...
cmple_i s16, s17, 179            # CHECK: 0x11,0xce,0x82,0x0a
cmple_i s16, v17, 179            # CHECK: 0x11,0xce,0x82,0x1a
...
cmpgt_u s19, s20, 196            # CHECK: 0x74,0x12,0x03,0x0b
cmpgt_u s19, v20, 196            # CHECK: 0x74,0x12,0x03,0x1b
...
cmpge_u s22, s23, 54             # CHECK: 0xd7,0xda,0x80,0x0b
cmpge_u s22, v23, 54             # CHECK: 0xd7,0xda,0x80,0x1b
...
cmplt_u s25, s26, 50             # CHECK: 0x3a,0xcb,0x00,0x0c
cmplt_u s25, v26, 50             # CHECK: 0x3a,0xcb,0x00,0x1c
...
cmple_u s0, s1, 139              # CHECK: 0x01,0x2c,0x82,0x0c
cmple_u s0, v1, 139              # CHECK: 0x01,0x2c,0x82,0x1c
...
load_v v1, 276(s2)               # CHECK: 0x22,0x50,0x04,0xae
load_v_mask v1, s3, 276(s2)      # CHECK: 0x22,0x0c,0x8a,0xb0
load_v v1, (s2)                  # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2)         # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 276(s2)              # CHECK: 0x22,0x50,0x04,0x8e
store_v_mask v1, s3, 276(s2)     # CHECK: 0x22,0x0c,0x8a,0x90
store_v v1, (s2)                 # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2)        # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 380(v5)            # CHECK: 0x85,0xf0,0x05,0xba
load_gath_mask v4, s6, 380(v5)   # CHECK: 0x85,0x18,0xbe,0xbc
load_gath v4, (v5)               # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5)      # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 380(v5)           # CHECK: 0x85,0xf0,0x05,0x9a
store_scat_mask v4, s6, 380(v5)  # CHECK: 0x85,0x18,0xbe,0x9c
