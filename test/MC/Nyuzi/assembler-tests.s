...
or s21, s22, 42 # CHECK: 0xb6,0xaa,0x00,0x00
or v24, v25, -56 # CHECK: 0x19,0x23,0x7f,0x10
or_mask v27, s1, v0, 73 # CHECK: 0x60,0x87,0x24,0x20
or v2, s3, 105 # CHECK: 0x43,0xa4,0x01,0x40
or_mask v5, s7, s6, 31 # CHECK: 0xa6,0x9c,0x0f,0x50
...
and s0, s1, 119 # CHECK: 0x01,0xdc,0x81,0x00
and v3, v4, -119 # CHECK: 0x64,0x24,0xfe,0x10
and_mask v6, s8, v7, -119 # CHECK: 0xc7,0xa0,0xc4,0x20
and v9, s10, -61 # CHECK: 0x2a,0x0d,0xff,0x40
and_mask v12, s14, s13, -53 # CHECK: 0x8d,0xb9,0xe5,0x50
...
xor s7, s8, -53 # CHECK: 0xe8,0x2c,0xff,0x01
xor v10, v11, 53 # CHECK: 0x4b,0xd5,0x80,0x11
xor_mask v13, s15, v14, 70 # CHECK: 0xae,0x3d,0xa3,0x21
xor v16, s17, -66 # CHECK: 0x11,0xfa,0xfe,0x41
xor_mask v19, s21, s20, -81 # CHECK: 0x74,0xd6,0xd7,0x51
...
add_i s14, s15, -104 # CHECK: 0xcf,0x61,0xfe,0x02
add_i v17, v18, 92 # CHECK: 0x32,0x72,0x81,0x12
add_i_mask v20, s22, v21, 59 # CHECK: 0x95,0xda,0x9d,0x22
add_i v23, s24, 14 # CHECK: 0xf8,0x3a,0x80,0x42
add_i_mask v26, s0, s27, -127 # CHECK: 0x5b,0x83,0xc0,0x52
...
sub_i s21, s22, -71 # CHECK: 0xb6,0xe6,0x7e,0x03
sub_i v24, v25, 109 # CHECK: 0x19,0xb7,0x01,0x13
sub_i_mask v27, s1, v0, -111 # CHECK: 0x60,0x87,0x48,0x23
sub_i v2, s3, -107 # CHECK: 0x43,0x54,0x7e,0x43
sub_i_mask v5, s7, s6, -59 # CHECK: 0xa6,0x9c,0x62,0x53
...
mull_i s0, s1, -60 # CHECK: 0x01,0x10,0xff,0x03
mull_i v3, v4, -28 # CHECK: 0x64,0x90,0xff,0x13
mull_i_mask v6, s8, v7, 110 # CHECK: 0xc7,0x20,0xb7,0x23
mull_i v9, s10, 55 # CHECK: 0x2a,0xdd,0x80,0x43
mull_i_mask v12, s14, s13, -127 # CHECK: 0x8d,0xb9,0xc0,0x53
...
mulh_u s7, s8, 10 # CHECK: 0xe8,0x28,0x00,0x04
mulh_u v10, v11, 21 # CHECK: 0x4b,0x55,0x00,0x14
mulh_u_mask v13, s15, v14, 55 # CHECK: 0xae,0xbd,0x1b,0x24
mulh_u v16, s17, 3 # CHECK: 0x11,0x0e,0x00,0x44
mulh_u_mask v19, s21, s20, -94 # CHECK: 0x74,0x56,0x51,0x54
...
ashr s14, s15, -38 # CHECK: 0xcf,0x69,0xff,0x04
ashr v17, v18, -99 # CHECK: 0x32,0x76,0xfe,0x14
ashr_mask v20, s22, v21, -4 # CHECK: 0x95,0x5a,0xfe,0x24
ashr v23, s24, 121 # CHECK: 0xf8,0xe6,0x81,0x44
ashr_mask v26, s0, s27, 25 # CHECK: 0x5b,0x83,0x8c,0x54
...
shr s21, s22, -37 # CHECK: 0xb6,0x6e,0x7f,0x05
shr v24, v25, 37 # CHECK: 0x19,0x97,0x00,0x15
shr_mask v27, s1, v0, -34 # CHECK: 0x60,0x07,0x6f,0x25
shr v2, s3, -9 # CHECK: 0x43,0xdc,0x7f,0x45
shr_mask v5, s7, s6, 14 # CHECK: 0xa6,0x1c,0x07,0x55
...
shl s0, s1, -48 # CHECK: 0x01,0x40,0xff,0x05
shl v3, v4, 80 # CHECK: 0x64,0x40,0x81,0x15
shl_mask v6, s8, v7, -50 # CHECK: 0xc7,0x20,0xe7,0x25
shl v9, s10, 68 # CHECK: 0x2a,0x11,0x81,0x45
shl_mask v12, s14, s13, 104 # CHECK: 0x8d,0x39,0xb4,0x55
...
mulh_i s11, s12, -98 # CHECK: 0x6c,0x79,0xfe,0x0f
mulh_i v14, v15, -106 # CHECK: 0xcf,0x59,0xfe,0x1f
mulh_i_mask v17, s19, v18, 49 # CHECK: 0x32,0xce,0x98,0x2f
mulh_i v20, s21, -116 # CHECK: 0x95,0x32,0xfe,0x4f
mulh_i_mask v23, s25, s24, 3 # CHECK: 0xf8,0xe6,0x81,0x5f
...
cmpeq_i s1, s2, 188 # CHECK: 0x22,0xf0,0x02,0x08
cmpeq_i s1, v2, 188 # CHECK: 0x22,0xf0,0x02,0x18
...
cmpne_i s4, s5, 115 # CHECK: 0x85,0xcc,0x81,0x08
cmpne_i s4, v5, 115 # CHECK: 0x85,0xcc,0x81,0x18
...
cmpgt_i s7, s8, 211 # CHECK: 0xe8,0x4c,0x03,0x09
cmpgt_i s7, v8, 211 # CHECK: 0xe8,0x4c,0x03,0x19
...
cmpge_i s10, s11, 201 # CHECK: 0x4b,0x25,0x83,0x09
cmpge_i s10, v11, 201 # CHECK: 0x4b,0x25,0x83,0x19
...
cmplt_i s13, s14, 214 # CHECK: 0xae,0x59,0x03,0x0a
cmplt_i s13, v14, 214 # CHECK: 0xae,0x59,0x03,0x1a
...
cmple_i s16, s17, 4 # CHECK: 0x11,0x12,0x80,0x0a
cmple_i s16, v17, 4 # CHECK: 0x11,0x12,0x80,0x1a
...
cmpgt_u s19, s20, 182 # CHECK: 0x74,0xda,0x02,0x0b
cmpgt_u s19, v20, 182 # CHECK: 0x74,0xda,0x02,0x1b
...
cmpge_u s22, s23, 20 # CHECK: 0xd7,0x52,0x80,0x0b
cmpge_u s22, v23, 20 # CHECK: 0xd7,0x52,0x80,0x1b
...
cmplt_u s25, s26, 32 # CHECK: 0x3a,0x83,0x00,0x0c
cmplt_u s25, v26, 32 # CHECK: 0x3a,0x83,0x00,0x1c
...
cmple_u s0, s1, 158 # CHECK: 0x01,0x78,0x82,0x0c
cmple_u s0, v1, 158 # CHECK: 0x01,0x78,0x82,0x1c
...
load_v v1, 268(s2) # CHECK: 0x22,0x30,0x04,0xae
load_v_mask v1, s3, 268(s2) # CHECK: 0x22,0x0c,0x86,0xb0
load_v v1, (s2) # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 268(s2) # CHECK: 0x22,0x30,0x04,0x8e
store_v_mask v1, s3, 268(s2) # CHECK: 0x22,0x0c,0x86,0x90
store_v v1, (s2) # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 276(v5) # CHECK: 0x85,0x50,0x04,0xba
load_gath_mask v4, s6, 276(v5) # CHECK: 0x85,0x18,0x8a,0xbc
load_gath v4, (v5) # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5) # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 276(v5) # CHECK: 0x85,0x50,0x04,0x9a
store_scat_mask v4, s6, 276(v5) # CHECK: 0x85,0x18,0x8a,0x9c
