...
or s21, s22, -47 # CHECK: 0xb6,0x46,0x7f,0x00
or v24, v25, -77 # CHECK: 0x19,0xcf,0x7e,0x10
or_mask v27, s1, v0, -45 # CHECK: 0x60,0x87,0x69,0x20
or v2, s3, 126 # CHECK: 0x43,0xf8,0x01,0x40
or_mask v5, s7, s6, -103 # CHECK: 0xa6,0x9c,0x4c,0x50
...
and s0, s1, 51 # CHECK: 0x01,0xcc,0x80,0x00
and v3, v4, -5 # CHECK: 0x64,0xec,0xff,0x10
and_mask v6, s8, v7, 25 # CHECK: 0xc7,0xa0,0x8c,0x20
and v9, s10, 101 # CHECK: 0x2a,0x95,0x81,0x40
and_mask v12, s14, s13, 82 # CHECK: 0x8d,0x39,0xa9,0x50
...
xor v10, v11, -89 # CHECK: 0x4b,0x9d,0xfe,0x11
xor_mask v13, s15, v14, 109 # CHECK: 0xae,0xbd,0xb6,0x21
xor v16, s17, 95 # CHECK: 0x11,0x7e,0x81,0x41
xor_mask v19, s21, s20, -47 # CHECK: 0x74,0xd6,0xe8,0x51
...
add_i s14, s15, 63 # CHECK: 0xcf,0xfd,0x80,0x02
add_i v17, v18, 124 # CHECK: 0x32,0xf2,0x81,0x12
add_i_mask v20, s22, v21, -28 # CHECK: 0x95,0x5a,0xf2,0x22
add_i v23, s24, -89 # CHECK: 0xf8,0x9e,0xfe,0x42
add_i_mask v26, s0, s27, -68 # CHECK: 0x5b,0x03,0xde,0x52
...
sub_i s21, s22, 2 # CHECK: 0xb6,0x0a,0x00,0x03
sub_i v24, v25, -125 # CHECK: 0x19,0x0f,0x7e,0x13
sub_i_mask v27, s1, v0, -42 # CHECK: 0x60,0x07,0x6b,0x23
sub_i v2, s3, 61 # CHECK: 0x43,0xf4,0x00,0x43
sub_i_mask v5, s7, s6, -81 # CHECK: 0xa6,0x9c,0x57,0x53
...
mull_i s0, s1, -4 # CHECK: 0x01,0xf0,0xff,0x03
mull_i v3, v4, -37 # CHECK: 0x64,0x6c,0xff,0x13
mull_i_mask v6, s8, v7, -77 # CHECK: 0xc7,0xa0,0xd9,0x23
mull_i v9, s10, -49 # CHECK: 0x2a,0x3d,0xff,0x43
mull_i_mask v12, s14, s13, -112 # CHECK: 0x8d,0x39,0xc8,0x53
...
mulh_u s7, s8, 32 # CHECK: 0xe8,0x80,0x00,0x04
mulh_u v10, v11, 59 # CHECK: 0x4b,0xed,0x00,0x14
mulh_u_mask v13, s15, v14, 46 # CHECK: 0xae,0x3d,0x17,0x24
mulh_u v16, s17, -122 # CHECK: 0x11,0x1a,0x7e,0x44
mulh_u_mask v19, s21, s20, -16 # CHECK: 0x74,0x56,0x78,0x54
...
ashr v17, v18, -18 # CHECK: 0x32,0xba,0xff,0x14
ashr_mask v20, s22, v21, -49 # CHECK: 0x95,0xda,0xe7,0x24
ashr v23, s24, 37 # CHECK: 0xf8,0x96,0x80,0x44
ashr_mask v26, s0, s27, -93 # CHECK: 0x5b,0x83,0xd1,0x54
...
shr s21, s22, 4 # CHECK: 0xb6,0x12,0x00,0x05
shr v24, v25, 58 # CHECK: 0x19,0xeb,0x00,0x15
shr_mask v27, s1, v0, 75 # CHECK: 0x60,0x87,0x25,0x25
shr v2, s3, 44 # CHECK: 0x43,0xb0,0x00,0x45
shr_mask v5, s7, s6, 18 # CHECK: 0xa6,0x1c,0x09,0x55
...
shl s0, s1, 40 # CHECK: 0x01,0xa0,0x80,0x05
shl v3, v4, -8 # CHECK: 0x64,0xe0,0xff,0x15
shl_mask v6, s8, v7, 71 # CHECK: 0xc7,0xa0,0xa3,0x25
shl v9, s10, -60 # CHECK: 0x2a,0x11,0xff,0x45
shl_mask v12, s14, s13, -124 # CHECK: 0x8d,0x39,0xc2,0x55
...
mulh_i s11, s12, -33 # CHECK: 0x6c,0x7d,0xff,0x0f
mulh_i v14, v15, -81 # CHECK: 0xcf,0xbd,0xfe,0x1f
mulh_i_mask v17, s19, v18, 83 # CHECK: 0x32,0xce,0xa9,0x2f
mulh_i v20, s21, -30 # CHECK: 0x95,0x8a,0xff,0x4f
mulh_i_mask v23, s25, s24, -9 # CHECK: 0xf8,0xe6,0xfb,0x5f
...
cmpeq_i s1, s2, 27 # CHECK: 0x22,0x6c,0x00,0x08
cmpeq_i s1, v2, 27 # CHECK: 0x22,0x6c,0x00,0x18
...
cmpne_i s4, s5, 192 # CHECK: 0x85,0x00,0x83,0x08
cmpne_i s4, v5, 192 # CHECK: 0x85,0x00,0x83,0x18
...
cmpgt_i s7, s8, 183 # CHECK: 0xe8,0xdc,0x02,0x09
cmpgt_i s7, v8, 183 # CHECK: 0xe8,0xdc,0x02,0x19
...
cmpge_i s10, s11, 197 # CHECK: 0x4b,0x15,0x83,0x09
cmpge_i s10, v11, 197 # CHECK: 0x4b,0x15,0x83,0x19
...
cmplt_i s13, s14, 111 # CHECK: 0xae,0xbd,0x01,0x0a
cmplt_i s13, v14, 111 # CHECK: 0xae,0xbd,0x01,0x1a
...
cmple_i s16, s17, 29 # CHECK: 0x11,0x76,0x80,0x0a
cmple_i s16, v17, 29 # CHECK: 0x11,0x76,0x80,0x1a
...
cmpgt_u s19, s20, 250 # CHECK: 0x74,0xea,0x03,0x0b
cmpgt_u s19, v20, 250 # CHECK: 0x74,0xea,0x03,0x1b
...
cmpge_u s22, s23, 216 # CHECK: 0xd7,0x62,0x83,0x0b
cmpge_u s22, v23, 216 # CHECK: 0xd7,0x62,0x83,0x1b
...
cmplt_u s25, s26, 48 # CHECK: 0x3a,0xc3,0x00,0x0c
cmplt_u s25, v26, 48 # CHECK: 0x3a,0xc3,0x00,0x1c
...
cmple_u s0, s1, 58 # CHECK: 0x01,0xe8,0x80,0x0c
cmple_u s0, v1, 58 # CHECK: 0x01,0xe8,0x80,0x1c
...
load_v v1, 244(s2) # CHECK: 0x22,0xd0,0x03,0xae
load_v_mask v1, s3, 244(s2) # CHECK: 0x22,0x0c,0x7a,0xb0
load_v v1, (s2) # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 244(s2) # CHECK: 0x22,0xd0,0x03,0x8e
store_v_mask v1, s3, 244(s2) # CHECK: 0x22,0x0c,0x7a,0x90
store_v v1, (s2) # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 240(v5) # CHECK: 0x85,0xc0,0x03,0xba
load_gath_mask v4, s6, 240(v5) # CHECK: 0x85,0x18,0x78,0xbc
load_gath v4, (v5) # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5) # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 240(v5) # CHECK: 0x85,0xc0,0x03,0x9a
store_scat_mask v4, s6, 240(v5) # CHECK: 0x85,0x18,0x78,0x9c
