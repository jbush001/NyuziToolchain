...
or s21, s22, 83                  # CHECK: 0xb6,0x4e,0x01,0x00
or v24, v25, -8                  # CHECK: 0x19,0xe3,0x7f,0x10
or_mask v27, s1, v0, 90          # CHECK: 0x60,0x07,0x2d,0x20
or v2, s3, -93                   # CHECK: 0x43,0x8c,0x7e,0x40
or_mask v5, s7, s6, -92          # CHECK: 0xa6,0x1c,0x52,0x50
...
and s0, s1, 13                   # CHECK: 0x01,0x34,0x80,0x00
and v3, v4, -53                  # CHECK: 0x64,0x2c,0xff,0x10
and_mask v6, s8, v7, -105        # CHECK: 0xc7,0xa0,0xcb,0x20
and v9, s10, -1                  # CHECK: 0x2a,0xfd,0xff,0x40
and_mask v12, s14, s13, 109      # CHECK: 0x8d,0xb9,0xb6,0x50
...
xor s7, s8, 54                   # CHECK: 0xe8,0xd8,0x80,0x01
xor v10, v11, -11                # CHECK: 0x4b,0xd5,0xff,0x11
xor_mask v13, s15, v14, -11      # CHECK: 0xae,0xbd,0xfa,0x21
xor v16, s17, -83                # CHECK: 0x11,0xb6,0xfe,0x41
xor_mask v19, s21, s20, -33      # CHECK: 0x74,0xd6,0xef,0x51
...
add_i s14, s15, 10               # CHECK: 0xcf,0x29,0x80,0x02
add_i v17, v18, -47              # CHECK: 0x32,0x46,0xff,0x12
add_i_mask v20, s22, v21, 14     # CHECK: 0x95,0x5a,0x87,0x22
add_i v23, s24, 89               # CHECK: 0xf8,0x66,0x81,0x42
add_i_mask v26, s0, s27, -53     # CHECK: 0x5b,0x83,0xe5,0x52
...
sub_i s21, s22, 116              # CHECK: 0xb6,0xd2,0x01,0x03
sub_i v24, v25, -111             # CHECK: 0x19,0x47,0x7e,0x13
sub_i_mask v27, s1, v0, -98      # CHECK: 0x60,0x07,0x4f,0x23
sub_i v2, s3, -113               # CHECK: 0x43,0x3c,0x7e,0x43
sub_i_mask v5, s7, s6, -12       # CHECK: 0xa6,0x1c,0x7a,0x53
...
mull_i s0, s1, -104              # CHECK: 0x01,0x60,0xfe,0x03
mull_i v3, v4, 68                # CHECK: 0x64,0x10,0x81,0x13
mull_i_mask v6, s8, v7, -99      # CHECK: 0xc7,0xa0,0xce,0x23
mull_i v9, s10, 109              # CHECK: 0x2a,0xb5,0x81,0x43
mull_i_mask v12, s14, s13, 52    # CHECK: 0x8d,0x39,0x9a,0x53
...
mulh_u s7, s8, -97               # CHECK: 0xe8,0x7c,0x7e,0x04
mulh_u v10, v11, -28             # CHECK: 0x4b,0x91,0x7f,0x14
mulh_u_mask v13, s15, v14, -47   # CHECK: 0xae,0xbd,0x68,0x24
mulh_u v16, s17, -96             # CHECK: 0x11,0x82,0x7e,0x44
mulh_u_mask v19, s21, s20, 39    # CHECK: 0x74,0xd6,0x13,0x54
...
ashr s14, s15, 3                 # CHECK: 0xcf,0x0d,0x80,0x04
ashr v17, v18, -49               # CHECK: 0x32,0x3e,0xff,0x14
ashr_mask v20, s22, v21, 127     # CHECK: 0x95,0xda,0xbf,0x24
ashr v23, s24, 37                # CHECK: 0xf8,0x96,0x80,0x44
ashr_mask v26, s0, s27, -124     # CHECK: 0x5b,0x03,0xc2,0x54
...
shr s21, s22, 112                # CHECK: 0xb6,0xc2,0x01,0x05
shr v24, v25, -16                # CHECK: 0x19,0xc3,0x7f,0x15
shr_mask v27, s1, v0, 107        # CHECK: 0x60,0x87,0x35,0x25
shr v2, s3, -19                  # CHECK: 0x43,0xb4,0x7f,0x45
shr_mask v5, s7, s6, -72         # CHECK: 0xa6,0x1c,0x5c,0x55
...
shl s0, s1, 85                   # CHECK: 0x01,0x54,0x81,0x05
shl v3, v4, -3                   # CHECK: 0x64,0xf4,0xff,0x15
shl_mask v6, s8, v7, -75         # CHECK: 0xc7,0xa0,0xda,0x25
shl v9, s10, 89                  # CHECK: 0x2a,0x65,0x81,0x45
shl_mask v12, s14, s13, -18      # CHECK: 0x8d,0x39,0xf7,0x55
...
mulh_i s11, s12, 56              # CHECK: 0x6c,0xe1,0x80,0x0f
mulh_i v14, v15, 115             # CHECK: 0xcf,0xcd,0x81,0x1f
mulh_i_mask v17, s19, v18, -4    # CHECK: 0x32,0x4e,0xfe,0x2f
mulh_i v20, s21, 62              # CHECK: 0x95,0xfa,0x80,0x4f
mulh_i_mask v23, s25, s24, 119   # CHECK: 0xf8,0xe6,0xbb,0x5f
...
cmpeq_i s1, s2, 30               # CHECK: 0x22,0x78,0x00,0x08
cmpeq_i s1, v2, 30               # CHECK: 0x22,0x78,0x00,0x18
...
cmpne_i s4, s5, 58               # CHECK: 0x85,0xe8,0x80,0x08
cmpne_i s4, v5, 58               # CHECK: 0x85,0xe8,0x80,0x18
...
cmpgt_i s7, s8, 8                # CHECK: 0xe8,0x20,0x00,0x09
cmpgt_i s7, v8, 8                # CHECK: 0xe8,0x20,0x00,0x19
...
cmpge_i s10, s11, 234            # CHECK: 0x4b,0xa9,0x83,0x09
cmpge_i s10, v11, 234            # CHECK: 0x4b,0xa9,0x83,0x19
...
cmplt_i s13, s14, 149            # CHECK: 0xae,0x55,0x02,0x0a
cmplt_i s13, v14, 149            # CHECK: 0xae,0x55,0x02,0x1a
...
cmple_i s16, s17, 58             # CHECK: 0x11,0xea,0x80,0x0a
cmple_i s16, v17, 58             # CHECK: 0x11,0xea,0x80,0x1a
...
cmpgt_u s19, s20, 92             # CHECK: 0x74,0x72,0x01,0x0b
cmpgt_u s19, v20, 92             # CHECK: 0x74,0x72,0x01,0x1b
...
cmpge_u s22, s23, 255            # CHECK: 0xd7,0xfe,0x83,0x0b
cmpge_u s22, v23, 255            # CHECK: 0xd7,0xfe,0x83,0x1b
...
cmplt_u s25, s26, 11             # CHECK: 0x3a,0x2f,0x00,0x0c
cmplt_u s25, v26, 11             # CHECK: 0x3a,0x2f,0x00,0x1c
...
cmple_u s0, s1, 173              # CHECK: 0x01,0xb4,0x82,0x0c
cmple_u s0, v1, 173              # CHECK: 0x01,0xb4,0x82,0x1c
...
load_v v1, 40(s2)                # CHECK: 0x22,0xa0,0x00,0xae
load_v_mask v1, s3, 40(s2)       # CHECK: 0x22,0x0c,0x14,0xb0
load_v v1, (s2)                  # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2)         # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 40(s2)               # CHECK: 0x22,0xa0,0x00,0x8e
store_v_mask v1, s3, 40(s2)      # CHECK: 0x22,0x0c,0x14,0x90
store_v v1, (s2)                 # CHECK: 0x22,0x00,0x00,0x8e
store_v_mask v1, s3, (s2)        # CHECK: 0x22,0x0c,0x00,0x90
load_gath v4, 20(v5)             # CHECK: 0x85,0x50,0x00,0xba
load_gath_mask v4, s6, 20(v5)    # CHECK: 0x85,0x18,0x0a,0xbc
load_gath v4, (v5)               # CHECK: 0x85,0x00,0x00,0xba
load_gath_mask v4, s6, (v5)      # CHECK: 0x85,0x18,0x00,0xbc
store_scat v4, 20(v5)            # CHECK: 0x85,0x50,0x00,0x9a
store_scat_mask v4, s6, 20(v5)   # CHECK: 0x85,0x18,0x0a,0x9c
...
breakpoint                       # CHECK: 0x00,0x00,0xe0,0xc3
