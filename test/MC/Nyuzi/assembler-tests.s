...
or s21, s22, -66 # CHECK: 0xb6,0xfa,0x7e,0x00
or v24, v25, -7 # CHECK: 0x19,0xe7,0x7f,0x10
or_mask v27, s1, v0, 109 # CHECK: 0x60,0x87,0x36,0x20
or v2, s3, 24 # CHECK: 0x43,0x60,0x00,0x40
or_mask v5, s7, s6, -40 # CHECK: 0xa6,0x1c,0x6c,0x50
...
and s0, s1, 52 # CHECK: 0x01,0xd0,0x80,0x00
and v3, v4, -80 # CHECK: 0x64,0xc0,0xfe,0x10
and_mask v6, s8, v7, -24 # CHECK: 0xc7,0x20,0xf4,0x20
and v9, s10, 126 # CHECK: 0x2a,0xf9,0x81,0x40
and_mask v12, s14, s13, -126 # CHECK: 0x8d,0x39,0xc1,0x50
...
xor s7, s8, -58 # CHECK: 0xe8,0x18,0xff,0x01
xor v10, v11, 107 # CHECK: 0x4b,0xad,0x81,0x11
xor_mask v13, s15, v14, -8 # CHECK: 0xae,0x3d,0xfc,0x21
xor v16, s17, 61 # CHECK: 0x11,0xf6,0x80,0x41
xor_mask v19, s21, s20, 122 # CHECK: 0x74,0x56,0xbd,0x51
...
add_i s14, s15, -8 # CHECK: 0xcf,0xe1,0xff,0x02
add_i v17, v18, -121 # CHECK: 0x32,0x1e,0xfe,0x12
add_i_mask v20, s22, v21, 27 # CHECK: 0x95,0xda,0x8d,0x22
add_i v23, s24, 43 # CHECK: 0xf8,0xae,0x80,0x42
...
sub_i s21, s22, -121 # CHECK: 0xb6,0x1e,0x7e,0x03
sub_i v24, v25, 8 # CHECK: 0x19,0x23,0x00,0x13
sub_i_mask v27, s1, v0, -51 # CHECK: 0x60,0x87,0x66,0x23
sub_i v2, s3, 57 # CHECK: 0x43,0xe4,0x00,0x43
sub_i_mask v5, s7, s6, 1 # CHECK: 0xa6,0x9c,0x00,0x53
...
mull_i s0, s1, -95 # CHECK: 0x01,0x84,0xfe,0x03
mull_i v3, v4, -78 # CHECK: 0x64,0xc8,0xfe,0x13
mull_i_mask v6, s8, v7, 32 # CHECK: 0xc7,0x20,0x90,0x23
mull_i v9, s10, -40 # CHECK: 0x2a,0x61,0xff,0x43
mull_i_mask v12, s14, s13, -76 # CHECK: 0x8d,0x39,0xda,0x53
...
mulh_u s7, s8, -101 # CHECK: 0xe8,0x6c,0x7e,0x04
mulh_u v10, v11, 63 # CHECK: 0x4b,0xfd,0x00,0x14
mulh_u_mask v13, s15, v14, 37 # CHECK: 0xae,0xbd,0x12,0x24
mulh_u v16, s17, -77 # CHECK: 0x11,0xce,0x7e,0x44
mulh_u_mask v19, s21, s20, -29 # CHECK: 0x74,0xd6,0x71,0x54
...
ashr s14, s15, 51 # CHECK: 0xcf,0xcd,0x80,0x04
ashr v17, v18, -105 # CHECK: 0x32,0x5e,0xfe,0x14
ashr_mask v20, s22, v21, 108 # CHECK: 0x95,0x5a,0xb6,0x24
ashr v23, s24, 116 # CHECK: 0xf8,0xd2,0x81,0x44
ashr_mask v26, s0, s27, 2 # CHECK: 0x5b,0x03,0x81,0x54
...
shr s21, s22, -121 # CHECK: 0xb6,0x1e,0x7e,0x05
shr v24, v25, -100 # CHECK: 0x19,0x73,0x7e,0x15
shr_mask v27, s1, v0, 96 # CHECK: 0x60,0x07,0x30,0x25
shr v2, s3, 111 # CHECK: 0x43,0xbc,0x01,0x45
shr_mask v5, s7, s6, -118 # CHECK: 0xa6,0x1c,0x45,0x55
...
shl s0, s1, 18 # CHECK: 0x01,0x48,0x80,0x05
shl v3, v4, 85 # CHECK: 0x64,0x54,0x81,0x15
shl_mask v6, s8, v7, 53 # CHECK: 0xc7,0xa0,0x9a,0x25
shl v9, s10, -11 # CHECK: 0x2a,0xd5,0xff,0x45
shl_mask v12, s14, s13, -15 # CHECK: 0x8d,0xb9,0xf8,0x55
...
mulh_i v14, v15, 85 # CHECK: 0xcf,0x55,0x81,0x1f
mulh_i_mask v17, s19, v18, -128 # CHECK: 0x32,0x4e,0xc0,0x2f
mulh_i v20, s21, 7 # CHECK: 0x95,0x1e,0x80,0x4f
...
cmpeq_i s1, s2, 209 # CHECK: 0x22,0x44,0x03,0x08
cmpeq_i s1, v2, 209 # CHECK: 0x22,0x44,0x03,0x18
...
cmpne_i s4, s5, 151 # CHECK: 0x85,0x5c,0x82,0x08
cmpne_i s4, v5, 151 # CHECK: 0x85,0x5c,0x82,0x18
...
cmpge_i s10, s11, 98 # CHECK: 0x4b,0x89,0x81,0x09
cmpge_i s10, v11, 98 # CHECK: 0x4b,0x89,0x81,0x19
...
cmplt_i s13, s14, 60 # CHECK: 0xae,0xf1,0x00,0x0a
cmplt_i s13, v14, 60 # CHECK: 0xae,0xf1,0x00,0x1a
...
cmple_i s16, s17, 139 # CHECK: 0x11,0x2e,0x82,0x0a
cmple_i s16, v17, 139 # CHECK: 0x11,0x2e,0x82,0x1a
...
cmpgt_u s19, s20, 104 # CHECK: 0x74,0xa2,0x01,0x0b
cmpgt_u s19, v20, 104 # CHECK: 0x74,0xa2,0x01,0x1b
...
cmpge_u s22, s23, 217 # CHECK: 0xd7,0x66,0x83,0x0b
cmpge_u s22, v23, 217 # CHECK: 0xd7,0x66,0x83,0x1b
...
cmplt_u s25, s26, 252 # CHECK: 0x3a,0xf3,0x03,0x0c
cmplt_u s25, v26, 252 # CHECK: 0x3a,0xf3,0x03,0x1c
...
cmple_u s0, s1, 224 # CHECK: 0x01,0x80,0x83,0x0c
cmple_u s0, v1, 224 # CHECK: 0x01,0x80,0x83,0x1c
...
load_v v1, 212(s2) # CHECK: 0x22,0x50,0x03,0xae
load_v_mask v1, s3, 212(s2) # CHECK: 0x22,0x0c,0x6a,0xb0
load_v v1, (s2) # CHECK: 0x22,0x00,0x00,0xae
load_v_mask v1, s3, (s2) # CHECK: 0x22,0x0c,0x00,0xb0
store_v v1, 212(s2) # CHECK: 0x22,0x50,0x03,0x8e
store_v_mask v1, s3, 212(s2) # CHECK: 0x22,0x0c,0x6a,0x90
