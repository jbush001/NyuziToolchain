...
0xb6 0xba 0x01 0x00 # CHECK: or s21, s22, 110
0x19 0x7b 0x00 0x10 # CHECK: or v24, v25, 30
0x60 0x87 0x7f 0x20 # CHECK: or_mask v27, s1, v0, -1
0x43 0x6c 0x01 0x40 # CHECK: or v2, s3, 91
0xa6 0x9c 0x20 0x50 # CHECK: or_mask v5, s7, s6, 65
...
0x01 0xcc 0xfe 0x00 # CHECK: and s0, s1, -77
0x64 0x44 0x81 0x10 # CHECK: and v3, v4, 81
0xc7 0x20 0xa3 0x20 # CHECK: and_mask v6, s8, v7, 70
0x2a 0xe1 0x80 0x40 # CHECK: and v9, s10, 56
0x8d 0xb9 0x80 0x50 # CHECK: and_mask v12, s14, s13, 1
...
0xe8 0x94 0xfe 0x01 # CHECK: xor s7, s8, -91
0x4b 0x3d 0xff 0x11 # CHECK: xor v10, v11, -49
0xae 0xbd 0xac 0x21 # CHECK: xor_mask v13, s15, v14, 89
0x11 0xee 0x80 0x41 # CHECK: xor v16, s17, 59
0x74 0xd6 0x9a 0x51 # CHECK: xor_mask v19, s21, s20, 53
...
0xcf 0x81 0x81 0x02 # CHECK: add_i s14, s15, 96
0x32 0xb2 0xff 0x12 # CHECK: add_i v17, v18, -20
0x95 0xda 0xb8 0x22 # CHECK: add_i_mask v20, s22, v21, 113
0xf8 0xc2 0x80 0x42 # CHECK: add_i v23, s24, 48
...
0xb6 0x6e 0x00 0x03 # CHECK: sub_i s21, s22, 27
0x19 0xef 0x7e 0x13 # CHECK: sub_i v24, v25, -69
0x60 0x87 0x59 0x23 # CHECK: sub_i_mask v27, s1, v0, -77
0x43 0x18 0x00 0x43 # CHECK: sub_i v2, s3, 6
0xa6 0x1c 0x0a 0x53 # CHECK: sub_i_mask v5, s7, s6, 20
...
0x01 0x9c 0x81 0x03 # CHECK: mull_i s0, s1, 103
0x64 0xe4 0xff 0x13 # CHECK: mull_i v3, v4, -7
0xc7 0x20 0x9e 0x23 # CHECK: mull_i_mask v6, s8, v7, 60
0x2a 0xcd 0xff 0x43 # CHECK: mull_i v9, s10, -13
0x8d 0xb9 0xa6 0x53 # CHECK: mull_i_mask v12, s14, s13, 77
0xf0 0x81 0x88 0xc0 # CHECK: mulhu_i s15, s16, s17
0x74 0x82 0x8a 0xc4 # CHECK: mulhu_i v19, v20, s21
0xf8 0xea 0x8c 0xc8 # CHECK: mulhu_i_mask v23, s26, v24, s25
0x60 0x83 0x80 0xd0 # CHECK: mulhu_i v27, v0, v1
0x64 0x98 0x82 0xd4 # CHECK: mulhu_i_mask v3, s6, v4, v5
0xe8 0x40 0x7f 0x04 # CHECK: mulhu_i s7, s8, -48
0x4b 0xa1 0x00 0x14 # CHECK: mulhu_i v10, v11, 40
0xae 0xbd 0x21 0x24 # CHECK: mulhu_i_mask v13, s15, v14, 67
0x11 0x6e 0x7e 0x44 # CHECK: mulhu_i v16, s17, -101
0x74 0x56 0x51 0x54 # CHECK: mulhu_i_mask v19, s21, s20, -94
...
0xcf 0x71 0x81 0x04 # CHECK: ashr s14, s15, 92
0x32 0x96 0x81 0x14 # CHECK: ashr v17, v18, 101
0x95 0x5a 0xd5 0x24 # CHECK: ashr_mask v20, s22, v21, -86
0xf8 0x06 0x81 0x44 # CHECK: ashr v23, s24, 65
0x5b 0x03 0xa2 0x54 # CHECK: ashr_mask v26, s0, s27, 68
...
0xb6 0x6e 0x7e 0x05 # CHECK: shr s21, s22, -101
0x19 0x13 0x01 0x15 # CHECK: shr v24, v25, 68
0x60 0x07 0x49 0x25 # CHECK: shr_mask v27, s1, v0, -110
0x43 0x6c 0x01 0x45 # CHECK: shr v2, s3, 91
0xa6 0x1c 0x7e 0x55 # CHECK: shr_mask v5, s7, s6, -4
...
0x01 0x10 0x80 0x05 # CHECK: shl s0, s1, 4
0x64 0x88 0x80 0x15 # CHECK: shl v3, v4, 34
0xc7 0xa0 0xba 0x25 # CHECK: shl_mask v6, s8, v7, 117
0x2a 0x31 0xfe 0x45 # CHECK: shl v9, s10, -116
0x8d 0x39 0xec 0x55 # CHECK: shl_mask v12, s14, s13, -40
...
0x74 0x82 0xfa 0xc1 # CHECK: mulhs_i s19, s20, s21
0xf8 0x82 0xfc 0xc5 # CHECK: mulhs_i v23, v24, s25
0x60 0x8b 0xf0 0xc9 # CHECK: mulhs_i_mask v27, s2, v0, s1
0x64 0x80 0xf2 0xd1 # CHECK: mulhs_i v3, v4, v5
0xe8 0xa8 0xf4 0xd5 # CHECK: mulhs_i_mask v7, s10, v8, v9
0x6c 0x21 0x80 0x0f # CHECK: mulhs_i s11, s12, 8
0xcf 0x11 0xfe 0x1f # CHECK: mulhs_i v14, v15, -124
0x32 0x4e 0xf9 0x2f # CHECK: mulhs_i_mask v17, s19, v18, -14
0x95 0x4e 0xfe 0x4f # CHECK: mulhs_i v20, s21, -109
0xf8 0xe6 0x97 0x5f # CHECK: mulhs_i_mask v23, s25, s24, 47
...
0x22 0x5c 0x03 0x08 # CHECK: cmpeq_i s1, s2, 215
0x22 0x5c 0x03 0x18 # CHECK: cmpeq_i s1, v2, 215
...
0x85 0x4c 0x82 0x08 # CHECK: cmpne_i s4, s5, 147
0x85 0x4c 0x82 0x18 # CHECK: cmpne_i s4, v5, 147
...
0xe8 0xa8 0x02 0x09 # CHECK: cmpgt_i s7, s8, 170
0xe8 0xa8 0x02 0x19 # CHECK: cmpgt_i s7, v8, 170
...
0x4b 0x01 0x81 0x09 # CHECK: cmpge_i s10, s11, 64
0x4b 0x01 0x81 0x19 # CHECK: cmpge_i s10, v11, 64
...
0xae 0x9d 0x02 0x0a # CHECK: cmplt_i s13, s14, 167
0xae 0x9d 0x02 0x1a # CHECK: cmplt_i s13, v14, 167
...
0x11 0x02 0x81 0x0a # CHECK: cmple_i s16, s17, 64
0x11 0x02 0x81 0x1a # CHECK: cmple_i s16, v17, 64
...
0x74 0xbe 0x02 0x0b # CHECK: cmpgt_u s19, s20, 175
0x74 0xbe 0x02 0x1b # CHECK: cmpgt_u s19, v20, 175
...
0xd7 0x36 0x82 0x0b # CHECK: cmpge_u s22, s23, 141
0xd7 0x36 0x82 0x1b # CHECK: cmpge_u s22, v23, 141
...
0x3a 0x9f 0x03 0x0c # CHECK: cmplt_u s25, s26, 231
0x3a 0x9f 0x03 0x1c # CHECK: cmplt_u s25, v26, 231
...
0x01 0xf4 0x82 0x0c # CHECK: cmple_u s0, s1, 189
0x01 0xf4 0x82 0x1c # CHECK: cmple_u s0, v1, 189
...
0x22 0x40 0x05 0xae # CHECK: load_v v1, 336(s2)
0x22 0x0c 0xa8 0xb0 # CHECK: load_v_mask v1, s3, 336(s2)
0x22 0x00 0x00 0xae # CHECK: load_v v1, (s2)
0x22 0x0c 0x00 0xb0 # CHECK: load_v_mask v1, s3, (s2)
0x22 0x40 0x05 0x8e # CHECK: store_v v1, 336(s2)
0x22 0x0c 0xa8 0x90 # CHECK: store_v_mask v1, s3, 336(s2)
0x22 0x00 0x00 0x8e # CHECK: store_v v1, (s2)
0x22 0x0c 0x00 0x90 # CHECK: store_v_mask v1, s3, (s2)
0x85 0xa0 0x04 0xba # CHECK: load_gath v4, 296(v5)
0x85 0x18 0x94 0xbc # CHECK: load_gath_mask v4, s6, 296(v5)
0x85 0x00 0x00 0xba # CHECK: load_gath v4, (v5)
0x85 0x18 0x00 0xbc # CHECK: load_gath_mask v4, s6, (v5)
0x85 0xa0 0x04 0x9a # CHECK: store_scat v4, 296(v5)
0x85 0x18 0x94 0x9c # CHECK: store_scat_mask v4, s6, 296(v5)
