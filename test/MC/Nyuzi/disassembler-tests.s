...
0xb6 0x9e 0x7f 0x00 # CHECK: or s21, s22, -25
0x19 0x67 0x7f 0x10 # CHECK: or v24, v25, -39
0x60 0x87 0x52 0x20 # CHECK: or_mask v27, s1, v0, -91
0x43 0x60 0x7e 0x40 # CHECK: or v2, s3, -104
0xa6 0x9c 0x53 0x50 # CHECK: or_mask v5, s7, s6, -89
...
0x01 0x24 0x80 0x00 # CHECK: and s0, s1, 9
0x64 0xa0 0xff 0x10 # CHECK: and v3, v4, -24
0xc7 0xa0 0xb3 0x20 # CHECK: and_mask v6, s8, v7, 103
0x2a 0xa1 0x81 0x40 # CHECK: and v9, s10, 104
0x8d 0x39 0x8d 0x50 # CHECK: and_mask v12, s14, s13, 26
...
0xe8 0x64 0xfe 0x01 # CHECK: xor s7, s8, -103
0x4b 0x39 0x81 0x11 # CHECK: xor v10, v11, 78
0xae 0xbd 0xc7 0x21 # CHECK: xor_mask v13, s15, v14, -113
0x11 0x96 0x80 0x41 # CHECK: xor v16, s17, 37
0x74 0xd6 0xeb 0x51 # CHECK: xor_mask v19, s21, s20, -41
...
0xcf 0x51 0x81 0x02 # CHECK: add_i s14, s15, 84
0x32 0x0e 0x80 0x12 # CHECK: add_i v17, v18, 3
0x95 0xda 0xbd 0x22 # CHECK: add_i_mask v20, s22, v21, 123
0xf8 0x82 0xfe 0x42 # CHECK: add_i v23, s24, -96
0x5b 0x03 0xfc 0x52 # CHECK: add_i_mask v26, s0, s27, -8
...
0xb6 0x32 0x7f 0x03 # CHECK: sub_i s21, s22, -52
0x19 0x17 0x7e 0x13 # CHECK: sub_i v24, v25, -123
0x60 0x07 0x3d 0x23 # CHECK: sub_i_mask v27, s1, v0, 122
0x43 0xc8 0x01 0x43 # CHECK: sub_i v2, s3, 114
0xa6 0x9c 0x1f 0x53 # CHECK: sub_i_mask v5, s7, s6, 63
...
0x01 0xc4 0xfe 0x03 # CHECK: mull_i s0, s1, -79
0x64 0xfc 0xff 0x13 # CHECK: mull_i v3, v4, -1
0xc7 0x20 0xfe 0x23 # CHECK: mull_i_mask v6, s8, v7, -4
0x2a 0xad 0x80 0x43 # CHECK: mull_i v9, s10, 43
0x8d 0x39 0xf7 0x53 # CHECK: mull_i_mask v12, s14, s13, -18
...
0xe8 0x8c 0x01 0x04 # CHECK: mulh_u s7, s8, 99
0x4b 0xe5 0x00 0x14 # CHECK: mulh_u v10, v11, 57
0xae 0x3d 0x35 0x24 # CHECK: mulh_u_mask v13, s15, v14, 106
0x11 0x66 0x7f 0x44 # CHECK: mulh_u v16, s17, -39
0x74 0xd6 0x33 0x54 # CHECK: mulh_u_mask v19, s21, s20, 103
...
0xcf 0x0d 0xfe 0x04 # CHECK: ashr s14, s15, -125
0x32 0xb2 0xff 0x14 # CHECK: ashr v17, v18, -20
0x95 0xda 0xa5 0x24 # CHECK: ashr_mask v20, s22, v21, 75
0xf8 0x56 0x81 0x44 # CHECK: ashr v23, s24, 85
0x5b 0x03 0x85 0x54 # CHECK: ashr_mask v26, s0, s27, 10
...
0xb6 0x5e 0x7e 0x05 # CHECK: shr s21, s22, -105
0x19 0xa7 0x7e 0x15 # CHECK: shr v24, v25, -87
0x60 0x07 0x30 0x25 # CHECK: shr_mask v27, s1, v0, 96
0x43 0xd4 0x7e 0x45 # CHECK: shr v2, s3, -75
0xa6 0x9c 0x15 0x55 # CHECK: shr_mask v5, s7, s6, 43
...
0x01 0xb4 0x81 0x05 # CHECK: shl s0, s1, 109
0x64 0xb0 0xff 0x15 # CHECK: shl v3, v4, -20
0xc7 0xa0 0xa4 0x25 # CHECK: shl_mask v6, s8, v7, 73
0x2a 0x81 0x80 0x45 # CHECK: shl v9, s10, 32
0x8d 0x39 0xed 0x55 # CHECK: shl_mask v12, s14, s13, -38
...
0x6c 0xc5 0xfe 0x0f # CHECK: mulh_i s11, s12, -79
0xcf 0xe9 0xff 0x1f # CHECK: mulh_i v14, v15, -6
0x32 0xce 0xd5 0x2f # CHECK: mulh_i_mask v17, s19, v18, -85
0x95 0x26 0x80 0x4f # CHECK: mulh_i v20, s21, 9
0xf8 0x66 0xf3 0x5f # CHECK: mulh_i_mask v23, s25, s24, -26
...
0x22 0x78 0x03 0x08 # CHECK: cmpeq_i s1, s2, 222
0x22 0x78 0x03 0x18 # CHECK: cmpeq_i s1, v2, 222
...
0x85 0x58 0x83 0x08 # CHECK: cmpne_i s4, s5, 214
0x85 0x58 0x83 0x18 # CHECK: cmpne_i s4, v5, 214
...
0xe8 0x4c 0x02 0x09 # CHECK: cmpgt_i s7, s8, 147
0xe8 0x4c 0x02 0x19 # CHECK: cmpgt_i s7, v8, 147
...
0x4b 0xf1 0x83 0x09 # CHECK: cmpge_i s10, s11, 252
0x4b 0xf1 0x83 0x19 # CHECK: cmpge_i s10, v11, 252
...
0xae 0xd1 0x01 0x0a # CHECK: cmplt_i s13, s14, 116
0xae 0xd1 0x01 0x1a # CHECK: cmplt_i s13, v14, 116
...
0x11 0x9a 0x81 0x0a # CHECK: cmple_i s16, s17, 102
0x11 0x9a 0x81 0x1a # CHECK: cmple_i s16, v17, 102
...
0x74 0xa2 0x03 0x0b # CHECK: cmpgt_u s19, s20, 232
0x74 0xa2 0x03 0x1b # CHECK: cmpgt_u s19, v20, 232
...
0xd7 0xa6 0x81 0x0b # CHECK: cmpge_u s22, s23, 105
0xd7 0xa6 0x81 0x1b # CHECK: cmpge_u s22, v23, 105
...
0x3a 0xf3 0x01 0x0c # CHECK: cmplt_u s25, s26, 124
0x3a 0xf3 0x01 0x1c # CHECK: cmplt_u s25, v26, 124
...
0x01 0x30 0x80 0x0c # CHECK: cmple_u s0, s1, 12
0x01 0x30 0x80 0x1c # CHECK: cmple_u s0, v1, 12
...
0x22 0x00 0x08 0xae # CHECK: load_v v1, 512(s2)
0x22 0x0c 0x00 0xb1 # CHECK: load_v_mask v1, s3, 512(s2)
0x22 0x00 0x00 0xae # CHECK: load_v v1, (s2)
0x22 0x0c 0x00 0xb0 # CHECK: load_v_mask v1, s3, (s2)
0x22 0x00 0x08 0x8e # CHECK: store_v v1, 512(s2)
0x22 0x0c 0x00 0x91 # CHECK: store_v_mask v1, s3, 512(s2)
0x22 0x00 0x00 0x8e # CHECK: store_v v1, (s2)
0x22 0x0c 0x00 0x90 # CHECK: store_v_mask v1, s3, (s2)
0x85 0x90 0x05 0xba # CHECK: load_gath v4, 356(v5)
0x85 0x18 0xb2 0xbc # CHECK: load_gath_mask v4, s6, 356(v5)
0x85 0x00 0x00 0xba # CHECK: load_gath v4, (v5)
0x85 0x18 0x00 0xbc # CHECK: load_gath_mask v4, s6, (v5)
0x85 0x90 0x05 0x9a # CHECK: store_scat v4, 356(v5)
0x85 0x18 0xb2 0x9c # CHECK: store_scat_mask v4, s6, 356(v5)
