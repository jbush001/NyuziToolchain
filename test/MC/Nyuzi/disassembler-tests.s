...
0xb6 0x46 0x7f 0x00 # CHECK: or s21, s22, -47
0x19 0xcf 0x7e 0x10 # CHECK: or v24, v25, -77
0x60 0x87 0x69 0x20 # CHECK: or_mask v27, s1, v0, -45
0x43 0xf8 0x01 0x40 # CHECK: or v2, s3, 126
0xa6 0x9c 0x4c 0x50 # CHECK: or_mask v5, s7, s6, -103
...
0x01 0xcc 0x80 0x00 # CHECK: and s0, s1, 51
0x64 0xec 0xff 0x10 # CHECK: and v3, v4, -5
0xc7 0xa0 0x8c 0x20 # CHECK: and_mask v6, s8, v7, 25
0x2a 0x95 0x81 0x40 # CHECK: and v9, s10, 101
0x8d 0x39 0xa9 0x50 # CHECK: and_mask v12, s14, s13, 82
...
0x4b 0x9d 0xfe 0x11 # CHECK: xor v10, v11, -89
0xae 0xbd 0xb6 0x21 # CHECK: xor_mask v13, s15, v14, 109
0x11 0x7e 0x81 0x41 # CHECK: xor v16, s17, 95
0x74 0xd6 0xe8 0x51 # CHECK: xor_mask v19, s21, s20, -47
...
0xcf 0xfd 0x80 0x02 # CHECK: add_i s14, s15, 63
0x32 0xf2 0x81 0x12 # CHECK: add_i v17, v18, 124
0x95 0x5a 0xf2 0x22 # CHECK: add_i_mask v20, s22, v21, -28
0xf8 0x9e 0xfe 0x42 # CHECK: add_i v23, s24, -89
0x5b 0x03 0xde 0x52 # CHECK: add_i_mask v26, s0, s27, -68
...
0xb6 0x0a 0x00 0x03 # CHECK: sub_i s21, s22, 2
0x19 0x0f 0x7e 0x13 # CHECK: sub_i v24, v25, -125
0x60 0x07 0x6b 0x23 # CHECK: sub_i_mask v27, s1, v0, -42
0x43 0xf4 0x00 0x43 # CHECK: sub_i v2, s3, 61
0xa6 0x9c 0x57 0x53 # CHECK: sub_i_mask v5, s7, s6, -81
...
0x01 0xf0 0xff 0x03 # CHECK: mull_i s0, s1, -4
0x64 0x6c 0xff 0x13 # CHECK: mull_i v3, v4, -37
0xc7 0xa0 0xd9 0x23 # CHECK: mull_i_mask v6, s8, v7, -77
0x2a 0x3d 0xff 0x43 # CHECK: mull_i v9, s10, -49
0x8d 0x39 0xc8 0x53 # CHECK: mull_i_mask v12, s14, s13, -112
...
0xe8 0x80 0x00 0x04 # CHECK: mulh_u s7, s8, 32
0x4b 0xed 0x00 0x14 # CHECK: mulh_u v10, v11, 59
0xae 0x3d 0x17 0x24 # CHECK: mulh_u_mask v13, s15, v14, 46
0x11 0x1a 0x7e 0x44 # CHECK: mulh_u v16, s17, -122
0x74 0x56 0x78 0x54 # CHECK: mulh_u_mask v19, s21, s20, -16
...
0x32 0xba 0xff 0x14 # CHECK: ashr v17, v18, -18
0x95 0xda 0xe7 0x24 # CHECK: ashr_mask v20, s22, v21, -49
0xf8 0x96 0x80 0x44 # CHECK: ashr v23, s24, 37
0x5b 0x83 0xd1 0x54 # CHECK: ashr_mask v26, s0, s27, -93
...
0xb6 0x12 0x00 0x05 # CHECK: shr s21, s22, 4
0x19 0xeb 0x00 0x15 # CHECK: shr v24, v25, 58
0x60 0x87 0x25 0x25 # CHECK: shr_mask v27, s1, v0, 75
0x43 0xb0 0x00 0x45 # CHECK: shr v2, s3, 44
0xa6 0x1c 0x09 0x55 # CHECK: shr_mask v5, s7, s6, 18
...
0x01 0xa0 0x80 0x05 # CHECK: shl s0, s1, 40
0x64 0xe0 0xff 0x15 # CHECK: shl v3, v4, -8
0xc7 0xa0 0xa3 0x25 # CHECK: shl_mask v6, s8, v7, 71
0x2a 0x11 0xff 0x45 # CHECK: shl v9, s10, -60
0x8d 0x39 0xc2 0x55 # CHECK: shl_mask v12, s14, s13, -124
...
0xcf 0xbd 0xfe 0x1f # CHECK: mulh_i v14, v15, -81
0x32 0xce 0xa9 0x2f # CHECK: mulh_i_mask v17, s19, v18, 83
0x95 0x8a 0xff 0x4f # CHECK: mulh_i v20, s21, -30
0xf8 0xe6 0xfb 0x5f # CHECK: mulh_i_mask v23, s25, s24, -9
...
0x22 0x6c 0x00 0x08 # CHECK: cmpeq_i s1, s2, 27
0x22 0x6c 0x00 0x18 # CHECK: cmpeq_i s1, v2, 27
...
0x85 0x00 0x83 0x08 # CHECK: cmpne_i s4, s5, 192
0x85 0x00 0x83 0x18 # CHECK: cmpne_i s4, v5, 192
...
0xe8 0xdc 0x02 0x09 # CHECK: cmpgt_i s7, s8, 183
0xe8 0xdc 0x02 0x19 # CHECK: cmpgt_i s7, v8, 183
...
0x4b 0x15 0x83 0x09 # CHECK: cmpge_i s10, s11, 197
0x4b 0x15 0x83 0x19 # CHECK: cmpge_i s10, v11, 197
...
0xae 0xbd 0x01 0x0a # CHECK: cmplt_i s13, s14, 111
0xae 0xbd 0x01 0x1a # CHECK: cmplt_i s13, v14, 111
...
0x11 0x76 0x80 0x0a # CHECK: cmple_i s16, s17, 29
0x11 0x76 0x80 0x1a # CHECK: cmple_i s16, v17, 29
...
0x74 0xea 0x03 0x0b # CHECK: cmpgt_u s19, s20, 250
0x74 0xea 0x03 0x1b # CHECK: cmpgt_u s19, v20, 250
...
0xd7 0x62 0x83 0x0b # CHECK: cmpge_u s22, s23, 216
0xd7 0x62 0x83 0x1b # CHECK: cmpge_u s22, v23, 216
...
0x3a 0xc3 0x00 0x0c # CHECK: cmplt_u s25, s26, 48
0x3a 0xc3 0x00 0x1c # CHECK: cmplt_u s25, v26, 48
...
0x01 0xe8 0x80 0x0c # CHECK: cmple_u s0, s1, 58
0x01 0xe8 0x80 0x1c # CHECK: cmple_u s0, v1, 58
...
0x22 0xd0 0x03 0xae # CHECK: load_v v1, 244(s2)
0x22 0x0c 0x7a 0xb0 # CHECK: load_v_mask v1, s3, 244(s2)
0x22 0x00 0x00 0xae # CHECK: load_v v1, (s2)
0x22 0x0c 0x00 0xb0 # CHECK: load_v_mask v1, s3, (s2)
0x22 0xd0 0x03 0x8e # CHECK: store_v v1, 244(s2)
0x22 0x0c 0x7a 0x90 # CHECK: store_v_mask v1, s3, 244(s2)
