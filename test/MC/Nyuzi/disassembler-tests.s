...
0xb6 0xbe 0x7e 0x00 # CHECK: or s21, s22, -81
0x19 0x23 0x01 0x10 # CHECK: or v24, v25, 72
0x60 0x87 0x31 0x20 # CHECK: or_mask v27, s1, v0, 99
0x43 0x90 0x7f 0x40 # CHECK: or v2, s3, -28
0xa6 0x9c 0x01 0x50 # CHECK: or_mask v5, s7, s6, 3
...
0x01 0x68 0xff 0x00 # CHECK: and s0, s1, -38
0x64 0x34 0xff 0x10 # CHECK: and v3, v4, -51
0xc7 0x20 0x90 0x20 # CHECK: and_mask v6, s8, v7, 32
0x2a 0x79 0xff 0x40 # CHECK: and v9, s10, -34
0x8d 0xb9 0xd9 0x50 # CHECK: and_mask v12, s14, s13, -77
...
0xe8 0xb4 0xfe 0x01 # CHECK: xor s7, s8, -83
0x4b 0x25 0x81 0x11 # CHECK: xor v10, v11, 73
0xae 0xbd 0xa3 0x21 # CHECK: xor_mask v13, s15, v14, 71
0x11 0xc2 0x81 0x41 # CHECK: xor v16, s17, 112
0x74 0x56 0xf8 0x51 # CHECK: xor_mask v19, s21, s20, -16
...
0xcf 0xc1 0xfe 0x02 # CHECK: add_i s14, s15, -80
0x32 0xb6 0xfe 0x12 # CHECK: add_i v17, v18, -83
0x95 0xda 0x9c 0x22 # CHECK: add_i_mask v20, s22, v21, 57
0xf8 0x4a 0xfe 0x42 # CHECK: add_i v23, s24, -110
0x5b 0x03 0xca 0x52 # CHECK: add_i_mask v26, s0, s27, -108
...
0xb6 0x3a 0x7f 0x03 # CHECK: sub_i s21, s22, -50
0x19 0xef 0x01 0x13 # CHECK: sub_i v24, v25, 123
0x60 0x07 0x62 0x23 # CHECK: sub_i_mask v27, s1, v0, -60
0x43 0x34 0x7f 0x43 # CHECK: sub_i v2, s3, -51
0xa6 0x9c 0x08 0x53 # CHECK: sub_i_mask v5, s7, s6, 17
...
0x01 0xe8 0x80 0x03 # CHECK: mull_i s0, s1, 58
0x64 0x5c 0xff 0x13 # CHECK: mull_i v3, v4, -41
0xc7 0x20 0xae 0x23 # CHECK: mull_i_mask v6, s8, v7, 92
0x2a 0x95 0x81 0x43 # CHECK: mull_i v9, s10, 101
0x8d 0xb9 0xa9 0x53 # CHECK: mull_i_mask v12, s14, s13, 83
...
0xe8 0xa0 0x00 0x04 # CHECK: mulh_u s7, s8, 40
0x4b 0x89 0x7f 0x14 # CHECK: mulh_u v10, v11, -30
0xae 0xbd 0x5a 0x24 # CHECK: mulh_u_mask v13, s15, v14, -75
0x11 0xfa 0x7f 0x44 # CHECK: mulh_u v16, s17, -2
0x74 0x56 0x06 0x54 # CHECK: mulh_u_mask v19, s21, s20, 12
...
0xcf 0xbd 0x80 0x04 # CHECK: ashr s14, s15, 47
0x32 0x2a 0x80 0x14 # CHECK: ashr v17, v18, 10
0x95 0x5a 0xf0 0x24 # CHECK: ashr_mask v20, s22, v21, -32
0xf8 0x52 0x81 0x44 # CHECK: ashr v23, s24, 84
0x5b 0x83 0xd5 0x54 # CHECK: ashr_mask v26, s0, s27, -85
...
0xb6 0x02 0x7e 0x05 # CHECK: shr s21, s22, -128
0x19 0xd7 0x01 0x15 # CHECK: shr v24, v25, 117
0x60 0x07 0x32 0x25 # CHECK: shr_mask v27, s1, v0, 100
0x43 0x6c 0x7e 0x45 # CHECK: shr v2, s3, -101
0xa6 0x1c 0x31 0x55 # CHECK: shr_mask v5, s7, s6, 98
...
0x01 0x94 0xfe 0x05 # CHECK: shl s0, s1, -91
0x64 0xec 0x81 0x15 # CHECK: shl v3, v4, 123
0xc7 0x20 0xd9 0x25 # CHECK: shl_mask v6, s8, v7, -78
0x2a 0x59 0xfe 0x45 # CHECK: shl v9, s10, -106
0x8d 0xb9 0xfb 0x55 # CHECK: shl_mask v12, s14, s13, -9
...
0x6c 0xf9 0xfe 0x0f # CHECK: mulh_i s11, s12, -66
0xcf 0xe1 0x80 0x1f # CHECK: mulh_i v14, v15, 56
0x32 0x4e 0xff 0x2f # CHECK: mulh_i_mask v17, s19, v18, -2
0x95 0xae 0x81 0x4f # CHECK: mulh_i v20, s21, 107
0xf8 0x66 0xfd 0x5f # CHECK: mulh_i_mask v23, s25, s24, -6
...
0x22 0x04 0x00 0x08 # CHECK: cmpeq_i s1, s2, 1
0x22 0x04 0x00 0x18 # CHECK: cmpeq_i s1, v2, 1
...
0xe8 0xa4 0x02 0x09 # CHECK: cmpgt_i s7, s8, 169
0xe8 0xa4 0x02 0x19 # CHECK: cmpgt_i s7, v8, 169
...
0x4b 0xf5 0x80 0x09 # CHECK: cmpge_i s10, s11, 61
0x4b 0xf5 0x80 0x19 # CHECK: cmpge_i s10, v11, 61
...
0xae 0x8d 0x00 0x0a # CHECK: cmplt_i s13, s14, 35
0xae 0x8d 0x00 0x1a # CHECK: cmplt_i s13, v14, 35
...
0x11 0x92 0x80 0x0a # CHECK: cmple_i s16, s17, 36
0x11 0x92 0x80 0x1a # CHECK: cmple_i s16, v17, 36
...
0x74 0x5e 0x03 0x0b # CHECK: cmpgt_u s19, s20, 215
0x74 0x5e 0x03 0x1b # CHECK: cmpgt_u s19, v20, 215
...
0xd7 0x42 0x83 0x0b # CHECK: cmpge_u s22, s23, 208
0xd7 0x42 0x83 0x1b # CHECK: cmpge_u s22, v23, 208
...
0x3a 0xff 0x01 0x0c # CHECK: cmplt_u s25, s26, 127
0x3a 0xff 0x01 0x1c # CHECK: cmplt_u s25, v26, 127
...
0x01 0x9c 0x80 0x0c # CHECK: cmple_u s0, s1, 39
0x01 0x9c 0x80 0x1c # CHECK: cmple_u s0, v1, 39
...
0x22 0x80 0x06 0xae # CHECK: load_v v1, 416(s2)
0x22 0x0c 0xd0 0xb0 # CHECK: load_v_mask v1, s3, 416(s2)
0x22 0x00 0x00 0xae # CHECK: load_v v1, (s2)
0x22 0x0c 0x00 0xb0 # CHECK: load_v_mask v1, s3, (s2)
0x22 0x80 0x06 0x8e # CHECK: store_v v1, 416(s2)
0x22 0x0c 0xd0 0x90 # CHECK: store_v_mask v1, s3, 416(s2)
0x22 0x00 0x00 0x8e # CHECK: store_v v1, (s2)
0x22 0x0c 0x00 0x90 # CHECK: store_v_mask v1, s3, (s2)
0x85 0xc0 0x07 0xba # CHECK: load_gath v4, 496(v5)
0x85 0x18 0xf8 0xbc # CHECK: load_gath_mask v4, s6, 496(v5)
0x85 0x00 0x00 0xba # CHECK: load_gath v4, (v5)
0x85 0x18 0x00 0xbc # CHECK: load_gath_mask v4, s6, (v5)
0x85 0xc0 0x07 0x9a # CHECK: store_scat v4, 496(v5)
0x85 0x18 0xf8 0x9c # CHECK: store_scat_mask v4, s6, 496(v5)
