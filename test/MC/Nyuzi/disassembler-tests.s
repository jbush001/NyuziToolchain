...
0xb6 0xaa 0x00 0x00 # CHECK: or s21, s22, 42
0x19 0x23 0x7f 0x10 # CHECK: or v24, v25, -56
0x60 0x87 0x24 0x20 # CHECK: or_mask v27, s1, v0, 73
0x43 0xa4 0x01 0x40 # CHECK: or v2, s3, 105
0xa6 0x9c 0x0f 0x50 # CHECK: or_mask v5, s7, s6, 31
...
0x01 0xdc 0x81 0x00 # CHECK: and s0, s1, 119
0x64 0x24 0xfe 0x10 # CHECK: and v3, v4, -119
0xc7 0xa0 0xc4 0x20 # CHECK: and_mask v6, s8, v7, -119
0x2a 0x0d 0xff 0x40 # CHECK: and v9, s10, -61
0x8d 0xb9 0xe5 0x50 # CHECK: and_mask v12, s14, s13, -53
...
0xe8 0x2c 0xff 0x01 # CHECK: xor s7, s8, -53
0x4b 0xd5 0x80 0x11 # CHECK: xor v10, v11, 53
0xae 0x3d 0xa3 0x21 # CHECK: xor_mask v13, s15, v14, 70
0x11 0xfa 0xfe 0x41 # CHECK: xor v16, s17, -66
0x74 0xd6 0xd7 0x51 # CHECK: xor_mask v19, s21, s20, -81
...
0xcf 0x61 0xfe 0x02 # CHECK: add_i s14, s15, -104
0x32 0x72 0x81 0x12 # CHECK: add_i v17, v18, 92
0x95 0xda 0x9d 0x22 # CHECK: add_i_mask v20, s22, v21, 59
0xf8 0x3a 0x80 0x42 # CHECK: add_i v23, s24, 14
0x5b 0x83 0xc0 0x52 # CHECK: add_i_mask v26, s0, s27, -127
...
0xb6 0xe6 0x7e 0x03 # CHECK: sub_i s21, s22, -71
0x19 0xb7 0x01 0x13 # CHECK: sub_i v24, v25, 109
0x60 0x87 0x48 0x23 # CHECK: sub_i_mask v27, s1, v0, -111
0x43 0x54 0x7e 0x43 # CHECK: sub_i v2, s3, -107
0xa6 0x9c 0x62 0x53 # CHECK: sub_i_mask v5, s7, s6, -59
...
0x01 0x10 0xff 0x03 # CHECK: mull_i s0, s1, -60
0x64 0x90 0xff 0x13 # CHECK: mull_i v3, v4, -28
0xc7 0x20 0xb7 0x23 # CHECK: mull_i_mask v6, s8, v7, 110
0x2a 0xdd 0x80 0x43 # CHECK: mull_i v9, s10, 55
0x8d 0xb9 0xc0 0x53 # CHECK: mull_i_mask v12, s14, s13, -127
...
0xe8 0x28 0x00 0x04 # CHECK: mulh_u s7, s8, 10
0x4b 0x55 0x00 0x14 # CHECK: mulh_u v10, v11, 21
0xae 0xbd 0x1b 0x24 # CHECK: mulh_u_mask v13, s15, v14, 55
0x11 0x0e 0x00 0x44 # CHECK: mulh_u v16, s17, 3
0x74 0x56 0x51 0x54 # CHECK: mulh_u_mask v19, s21, s20, -94
...
0xcf 0x69 0xff 0x04 # CHECK: ashr s14, s15, -38
0x32 0x76 0xfe 0x14 # CHECK: ashr v17, v18, -99
0x95 0x5a 0xfe 0x24 # CHECK: ashr_mask v20, s22, v21, -4
0xf8 0xe6 0x81 0x44 # CHECK: ashr v23, s24, 121
0x5b 0x83 0x8c 0x54 # CHECK: ashr_mask v26, s0, s27, 25
...
0xb6 0x6e 0x7f 0x05 # CHECK: shr s21, s22, -37
0x19 0x97 0x00 0x15 # CHECK: shr v24, v25, 37
0x60 0x07 0x6f 0x25 # CHECK: shr_mask v27, s1, v0, -34
0x43 0xdc 0x7f 0x45 # CHECK: shr v2, s3, -9
0xa6 0x1c 0x07 0x55 # CHECK: shr_mask v5, s7, s6, 14
...
0x01 0x40 0xff 0x05 # CHECK: shl s0, s1, -48
0x64 0x40 0x81 0x15 # CHECK: shl v3, v4, 80
0xc7 0x20 0xe7 0x25 # CHECK: shl_mask v6, s8, v7, -50
0x2a 0x11 0x81 0x45 # CHECK: shl v9, s10, 68
0x8d 0x39 0xb4 0x55 # CHECK: shl_mask v12, s14, s13, 104
...
0x6c 0x79 0xfe 0x0f # CHECK: mulh_i s11, s12, -98
0xcf 0x59 0xfe 0x1f # CHECK: mulh_i v14, v15, -106
0x32 0xce 0x98 0x2f # CHECK: mulh_i_mask v17, s19, v18, 49
0x95 0x32 0xfe 0x4f # CHECK: mulh_i v20, s21, -116
0xf8 0xe6 0x81 0x5f # CHECK: mulh_i_mask v23, s25, s24, 3
...
0x22 0xf0 0x02 0x08 # CHECK: cmpeq_i s1, s2, 188
0x22 0xf0 0x02 0x18 # CHECK: cmpeq_i s1, v2, 188
...
0x85 0xcc 0x81 0x08 # CHECK: cmpne_i s4, s5, 115
0x85 0xcc 0x81 0x18 # CHECK: cmpne_i s4, v5, 115
...
0x4b 0x25 0x83 0x09 # CHECK: cmpge_i s10, s11, 201
0x4b 0x25 0x83 0x19 # CHECK: cmpge_i s10, v11, 201
...
0xae 0x59 0x03 0x0a # CHECK: cmplt_i s13, s14, 214
0xae 0x59 0x03 0x1a # CHECK: cmplt_i s13, v14, 214
...
0x11 0x12 0x80 0x0a # CHECK: cmple_i s16, s17, 4
0x11 0x12 0x80 0x1a # CHECK: cmple_i s16, v17, 4
...
0x74 0xda 0x02 0x0b # CHECK: cmpgt_u s19, s20, 182
0x74 0xda 0x02 0x1b # CHECK: cmpgt_u s19, v20, 182
...
0xd7 0x52 0x80 0x0b # CHECK: cmpge_u s22, s23, 20
0xd7 0x52 0x80 0x1b # CHECK: cmpge_u s22, v23, 20
...
0x3a 0x83 0x00 0x0c # CHECK: cmplt_u s25, s26, 32
0x3a 0x83 0x00 0x1c # CHECK: cmplt_u s25, v26, 32
...
0x01 0x78 0x82 0x0c # CHECK: cmple_u s0, s1, 158
0x01 0x78 0x82 0x1c # CHECK: cmple_u s0, v1, 158
...
0x22 0x30 0x04 0xae # CHECK: load_v v1, 268(s2)
0x22 0x0c 0x86 0xb0 # CHECK: load_v_mask v1, s3, 268(s2)
0x22 0x00 0x00 0xae # CHECK: load_v v1, (s2)
0x22 0x0c 0x00 0xb0 # CHECK: load_v_mask v1, s3, (s2)
0x22 0x30 0x04 0x8e # CHECK: store_v v1, 268(s2)
0x22 0x0c 0x86 0x90 # CHECK: store_v_mask v1, s3, 268(s2)
0x22 0x00 0x00 0x8e # CHECK: store_v v1, (s2)
0x22 0x0c 0x00 0x90 # CHECK: store_v_mask v1, s3, (s2)
0x85 0x50 0x04 0xba # CHECK: load_gath v4, 276(v5)
0x85 0x18 0x8a 0xbc # CHECK: load_gath_mask v4, s6, 276(v5)
0x85 0x00 0x00 0xba # CHECK: load_gath v4, (v5)
0x85 0x18 0x00 0xbc # CHECK: load_gath_mask v4, s6, (v5)
0x85 0x50 0x04 0x9a # CHECK: store_scat v4, 276(v5)
0x85 0x18 0x8a 0x9c # CHECK: store_scat_mask v4, s6, 276(v5)
