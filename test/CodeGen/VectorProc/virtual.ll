...
entry:
	...
	%0 = load %class.Foo** %f.addr, align 4
	%1 = bitcast %class.Foo* %0 to void (%class.Foo*, i32)***
	%vtable = load void (%class.Foo*, i32)*** %1
	%vfn = getelementptr inbounds void (%class.Foo*, i32)** %vtable, i64 0
	%2 = load void (%class.Foo*, i32)** %vfn
