...
declare <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %a, <16 x i32> %b)
declare <16 x float> @llvm.vectorproc.__builtin_vp_vector_mixf(i32 %mask, <16 x float> %a, <16 x float> %b)
...
define <16 x i32> @test1(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test1
	...
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %sum, <16 x i32> %a)
...
define <16 x i32> @test2(i32 %mask, <16 x i32> %a, <16 x i32> %b) { ; CHECK: test2
	...
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %notmask, <16 x i32> %sum, <16 x i32> %a)
...
define <16 x i32> @test7(i32 %mask, i32 %a, <16 x i32> %b) {	; CHECK: test7:
	...
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %sum, <16 x i32> %b)
...
define <16 x i32> @test8(i32 %mask, i32 %a, <16 x i32> %b) {	; CHECK: test8:
	...
	%sum = add <16 x i32> %splat, <i32 48, i32 48, i32 48, i32 48, i32 48, i32 48, i32 48, 
	    i32 48, i32 48, i32 48, i32 48, i32 48, i32 48, i32 48, i32 48, i32 48>
	%notmask = xor i32 %mask, -1
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %notmask, <16 x i32> %sum, <16 x i32> %b)
...
define <16 x float> @test9(i32 %mask, <16 x float> %a, <16 x float> %b) { ; CHECK: test9
	...
	%c = call <16 x float> @llvm.vectorproc.__builtin_vp_vector_mixf(i32 %mask, <16 x float> %sum, <16 x float> %a)
...
define <16 x float> @test10(i32 %mask, <16 x float> %a, <16 x float> %b) { ; CHECK: test10
	%sum = fadd <16 x float> %a, %b
	%notmask = xor i32 %mask, -1
	%c = call <16 x float> @llvm.vectorproc.__builtin_vp_vector_mixf(i32 %notmask, <16 x float> %sum, <16 x float> %a)
...
define <16 x i32> @test13(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test13
	...
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %res, <16 x i32> %a)
...
define <16 x i32> @test14(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test14
	%res = call <16 x i32> @llvm.ctlz.v16i32(<16 x i32> %b, i1 0)
	%notmask = xor i32 %mask, -1
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %notmask, <16 x i32> %res, <16 x i32> %a)
...
define <16 x i32> @test17(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test17
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %a, <16 x i32> %b)
...
define <16 x i32> @test18(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test18
	%notmask = xor i32 %mask, -1
	%c = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %notmask, <16 x i32> %a, <16 x i32> %b)
...
define <16 x i32> @test19(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test19
	...
	%blended = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %mask, <16 x i32> %shuffled, <16 x i32> %a)
...
define <16 x i32> @test20(i32 %mask, <16 x i32> %a, <16 x i32> %b) {	; CHECK: test20
	%notmask = xor i32 %mask, -1
	%shuffled = call <16 x i32> @llvm.vectorproc.__builtin_vp_shufflei(<16 x i32> %a, <16 x i32> %b)
	%blended = call <16 x i32> @llvm.vectorproc.__builtin_vp_vector_mixi(i32 %notmask, <16 x i32> %shuffled, <16 x i32> %a)
