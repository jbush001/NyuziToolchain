...
StringRef getELFRelocationTypeName(uint32_t Machine, uint32_t Type) {
  ...
  case ELF::EM_NYUZI:
    switch (Type) {
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_NYUZI_ABS32);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_NYUZI_BRANCH);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_NYUZI_PCREL_MEM_EXT);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_NYUZI_PCREL_MEM);
    default: break;
    }
    break;
  case ELF::EM_SPARC:
