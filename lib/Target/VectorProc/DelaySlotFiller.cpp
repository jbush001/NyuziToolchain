//===-- DelaySlotFiller.cpp - VECTORPROC delay slot filler ---------------------===//
//
...
static cl::opt<bool> DisableDelaySlotFiller(
  "disable-vectorproc-delay-filler",
  cl::init(false),
  cl::desc("Disable the VectorProc delay slot filler."),
  cl::Hidden);
...
namespace {
  struct Filler : public MachineFunctionPass {
    ...
    virtual const char *getPassName() const {
      return "VECTORPROC Delay Slot Filler";
    }
...
/// createVectorProcDelaySlotFillerPass - Returns a pass that fills in delay
/// slots in VectorProc MachineFunctions
///
FunctionPass *llvm::createVectorProcDelaySlotFillerPass(TargetMachine &tm) {
