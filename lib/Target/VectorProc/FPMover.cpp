//===-- FPMover.cpp - VectorProc double-precision floating point move fixer ----===//
//
...
namespace {
  struct FPMover : public MachineFunctionPass {
    ...
    virtual const char *getPassName() const {
      return "VectorProc Double-FP Move Fixer";
    }
...
/// createVectorProcFPMoverPass - Returns a pass that turns FpMOVD
/// instructions into FMOVS instructions
///
FunctionPass *llvm::createVectorProcFPMoverPass(TargetMachine &tm) {
