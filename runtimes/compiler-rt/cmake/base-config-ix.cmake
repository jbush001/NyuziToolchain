...
# XXX Nyuzi: clang doesn't add a path component if there is no OS, just leave
# it blank.
if(NOT DEFINED COMPILER_RT_OS_DIR AND XXX_DISABLE_NYUZI)
  string(TOLOWER ${CMAKE_SYSTEM_NAME} COMPILER_RT_OS_DIR)
endif()
if(LLVM_ENABLE_PER_TARGET_RUNTIME_DIR AND NOT APPLE AND XXX_DISABLE_NYUZI)
...
macro(test_targets)
  ...
  elseif(NOT (APPLE AND XXX_DISABLE_NYUZI)) # Supported archs for Apple platforms are generated later
    ...
    elseif("${COMPILER_RT_DEFAULT_TARGET_ARCH}" MATCHES "nyuzi")
      test_target_arch(nyuzi "" "--target=nyuzi-unknown-unknown")
    endif()
